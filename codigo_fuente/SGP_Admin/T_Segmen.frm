...
If modo = "A" Then
   ...
   codigo = 0
   Set RS = vg_db.Execute("sgpadm_iu_segmento 'A', 0, '" & Trim(Nombre) & "'")
   If Not RS.EOF Then
...
Else
   ...
   vg_db.Execute "sgpadm_iu_segmento 'M', " & codigo & ", '" & Trim(Nombre) & "'"
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
    ...
    Set RS = vg_db.Execute("sgpadm_s_segmento 3, 0, '%" & UCase(LimpiaDato(fpText1.text)) & "%'")

ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
    
    Set RS = vg_db.Execute("sgpadm_s_segmento 4, 0, '%" & UCase(LimpiaDato(fpText1.text)) & "%'")
...
If Not RS.EOF Then
   ...
   Do While Not RS.EOF
      ...
      vaSpread1.Value = RS!seg_codigo
      
      vaSpread1.Col = 2
      vaSpread1.Value = IIf(IsNull(RS!seg_nombre), "", Trim(RS!seg_nombre))
...
Set RS = vg_db.Execute("sgpadm_Sel_Segmento")
Do While Not RS.EOF
...
Set RS = vg_db.Execute("SELECT * FROM a_segmento WHERE seg_codigo=" & codigo & "")
