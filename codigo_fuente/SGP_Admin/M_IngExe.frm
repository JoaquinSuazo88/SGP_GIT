...
Begin VB.Form M_IngExe 
   ...
   Begin VB.Frame Frame1 
      Caption         =   "Ingrediente que Participan en el Pedido"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         MaxRows         =   2
         ScrollBars      =   2
         SpreadDesigner  =   "M_IngExe.frx":0000
      End
      Begin EditLib.fpText TEXT1 
         Height          =   315
         Index           =   2
   ...
   Begin VB.Frame Frame2 
      Caption         =   "Ingrediente que NO Participan en el Pedido"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Begin FPSpread.vaSpread vaSpread2 
         ...
         MaxRows         =   2
         ScrollBars      =   2
         SpreadDesigner  =   "M_IngExe.frx":03F8
      End
      Begin EditLib.fpText text2 
         Height          =   315
         Index           =   3
...
Private Sub carga_productos_con_Arrastre()
 ...
 On Error GoTo Man_Error
    Sql = " sgpadm_sel_Ingredientes_Exepcion "
...
Private Sub carga_productos_sap()
 ...
 On Error GoTo Man_Error
    Sql = " sgpadm_sel_Ingrediente_Sin_Exepcion "
    Set RS = vg_db.Execute(Sql)
...
' Rescata la Familia de Producto Seleccionada
  ...
  Next i
    ...
    Sql = " sgpadm_iu_Ingredientes_con_Exepciones "
    Sql = Sql & " '" & xmlfamilia & "'"
    Set RS = vg_db.Execute(Sql)
