...
Begin VB.Form M_ProCas 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         MaxCols         =   3
         MaxRows         =   2
         SpreadDesigner  =   "M_ProCas.frx":04D1
         TextTip         =   2
         TextTipDelay    =   0
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   315
            Index           =   0
            ItemData        =   "M_ProCas.frx":0912
            Left            =   1680
            List            =   "M_ProCas.frx":091C
            Style           =   2  'Dropdown List
            TabIndex        =   0
            Top             =   240
            Width           =   2865
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         MaxCols         =   3
         MaxRows         =   1
         SpreadDesigner  =   "M_ProCas.frx":0930
         TextTip         =   2
         TextTipDelay    =   0
      End
      Begin MSComctlLib.ProgressBar Bar1 
   ...
   Begin CHILKATMAILLib2Ctl.ChilkatMailMan2 oMail 
      Left            =   5040
      OleObjectBlob   =   "M_ProCas.frx":0D1A
      Top             =   6840
   End
   Begin CHILKATFTPLibCtl.ChilkatFTP oFTP 
      Left            =   4320
      OleObjectBlob   =   "M_ProCas.frx":0D3E
      Top             =   6750
   End
End
