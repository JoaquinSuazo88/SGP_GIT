...
Begin VB.Form T_EstacionalidadReceta 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Estacionalidad Receta"
   ClientHeight    =   4950
   ClientLeft      =   2940
   ClientTop       =   1110
   ClientWidth     =   13380
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "T_EstacionalidadReceta.frx":0000
         Left            =   2010
         List            =   "T_EstacionalidadReceta.frx":000A
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      MaxCols         =   8
      ProcessTab      =   -1  'True
      SpreadDesigner  =   "T_EstacionalidadReceta.frx":001E
      ScrollBarTrack  =   3
      ClipboardOptions=   0
   End
   ...
   End
End
Attribute VB_Name = "T_EstacionalidadReceta"
...
If Trim(Nombre) = "" Then
   ...
   MsgBox "Falta información descripción...", vbExclamation + vbOKOnly, MsgTitulo
   vaSpread1.Row = Fila
   vaSpread1.Col = 2
...
If Mid(FechaIni, 3, 1) <> "/" Then
   ...
   vaSpread1.SetActiveCell 3, Fila
   vaSpread1.SetFocus
...
If Mid(FechaFin, 3, 1) <> "/" Then
   ...
   vaSpread1.SetActiveCell 4, Fila
   vaSpread1.SetFocus
   MsgBox "debe utilizar un separador " & "/ fecha fin", vbCritical, "Boton_Click"
   Exit Sub
...
For i = 1 To vaSpread1.MaxRows
    ...
    vaSpread1.Col = 2
    AuxNombre = Trim(vaSpread1.Value)
    ...
    If i <> Fila Then
       ...
       If Nombre = AuxNombre And FechaIni = AuxFechaIni And FechaFin = AuxFechaFin Then
       
          MsgBox "El dato ya existe registrado...", vbCritical + vbOKOnly, MsgTitulo
          Exit Sub
          
       ElseIf Nombre = AuxNombre And (Format(FechaIni, "mmdd") >= Format(AuxFechaIni, "mmdd")) And (Format(FechaIni, "mmdd") <= Format(AuxFechaFin, "mmdd")) Then
          
          MsgBox "El dato esta traslapado...", vbCritical + vbOKOnly, MsgTitulo
          Exit Sub
                    
       ElseIf Nombre = AuxNombre And (Format(FechaFin, "mmdd") >= Format(AuxFechaIni, "mmdd")) And (Format(FechaFin, "mmdd") <= Format(AuxFechaFin, "mmdd")) Then
...
If modo = "A" Then
   ...
   codigo = 0
   Set RS = vg_db.Execute("sgpadm_Ins_EstacionalidadReceta '" & Trim(Nombre) & "', " & FechaIni & ", " & FechaFin & ", '" & vg_NUsr & "'")
   If Not RS.EOF Then
      ...
      If RS(0) = 0 Then
         ...
         MensajeNuevo = codigo & ";" & Trim(Nombre) & ";" & FechaIni & ";" & FechaFin & ";" & 1 & ";" & vg_NUsr
      ...
      Else
         ...
         MensajeNuevo = Trim(Nombre) & ";" & FechaIni & ";" & FechaFin & ";" & 1 & ";" & vg_NUsr
...
Else
   ...
   Set RS = vg_db.Execute("sgpadm_Sel_CodigoEstacionalidadReceta " & codigo & "")
   If Not RS.EOF Then
       
      MensajeAnterior = codigo & ";" & IIf(IsNull(RS!NombreEstacionalidad), "", Trim(RS!NombreEstacionalidad)) & ";" & IIf(IsNull(RS!fecha_inicial), "", Trim(RS!fecha_inicial)) & ";" & IIf(IsNull(RS!fecha_Final), "", Trim(RS!fecha_Final)) & ";" & IIf(IsNull(RS!Activo), "", Trim(RS!Activo)) & ";" & vg_NUsr
   ...
   Set RS = vg_db.Execute("sgpadm_Upd_EstacionalidadReceta " & codigo & ", '" & Trim(Nombre) & "', '" & FechaIni & "', '" & FechaFin & "', '" & Activo & "', '" & vg_NUsr & "'")

   If Not RS.EOF Then
      
      If RS(0) = 0 Then
           
         MensajeNuevo = codigo & ";" & Trim(Nombre) & ";" & FechaIni & ";" & FechaFin & ";" & Activo & ";" & vg_NUsr
...
Me.Height = 5385
Me.Width = 13470
MsgTitulo = "Estacionalidad Receta"
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
   ...
   Set RS = vg_db.Execute("sgpadm_Sel_BuscarCodigoEstacionalidadReceta '%" & UCase(LimpiaDato(fpText1.text)) & "%'")

ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
    
   Set RS = vg_db.Execute("sgpadm_Sel_BuscarNombreEstacionalidadReceta '%" & UCase(LimpiaDato(fpText1.text)) & "%'")
...
If Not RS.EOF Then
   ...
   Do While Not RS.EOF
      ...
      vaSpread1.Value = RS!IdEstacionalidad
      
      vaSpread1.Col = 2
      vaSpread1.Value = IIf(IsNull(RS!NombreEstacionalidad), "", Trim(RS!NombreEstacionalidad))
      
      vaSpread1.Col = 3
      vaSpread1.Value = IIf(IsNull(RS!fecha_inicial), "", Trim(RS!fecha_inicial))
      
      vaSpread1.Col = 4
      vaSpread1.Value = IIf(IsNull(RS!fecha_Final), "", Trim(RS!fecha_Final))
...
Case 5
    ...
    Mensaje = ""
    Mensaje = codigo & ";" & Nombre & ";" & FechaIni & ";" & FechaFin & ";" & Activo & vg_NUsr
    ...
    Set RS = vg_db.Execute("sgpadm_Del_EstacionalidadReceta " & codigo & ", '0', '" & vg_NUsr & "'")
...
Set RS = vg_db.Execute("sgpadm_Sel_EstacionalidadesReceta")
...
Private Sub MostrarRegistro(IRow)
