...
Combo1(1).Clear
Combo1(1).AddItem "FACTURA" & Space(150) & "(FA)"
Combo1(1).AddItem "GUIA DE DEPACHO" & Space(150) & "(GD)"
Combo1(1).AddItem "NOTA DE CREDITO" & Space(150) & "(NC)"
Combo1(1).AddItem "NOTA DE DEBITO" & Space(150) & "(ND)"
Combo1(1).AddItem "BOLETA" & Space(150) & "(BO)"
Combo1(1).AddItem "BOLETA DE HONORARIOS" & Space(150) & "(BH)"
'***** Limpia Objetos *****
Fecha(0).Text = "": Fecha(1).Text = ""
fpText1(0).Text = ""
Check1(0).Value = 0: Check1(1).Value = 0: Check1(2).Value = 0: Check1(3).Value = 0
If Combo1(0).ListCount > 0 Then Combo1(0).ListIndex = 0
'***** Deshabilita Objetos *****
Combo1(0).Enabled = False: Combo1(1).Enabled = False
Fecha(0).Enabled = False: Fecha(1).Enabled = False
fpText1(0).Enabled = False: Image1(0).Enabled = False: label2(0).Enabled = False
Exit Sub
Error_Partida:
