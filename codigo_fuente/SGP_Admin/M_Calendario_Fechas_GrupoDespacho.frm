...
Begin VB.Form M_Calendario_Fechas_GrupoDespacho 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Calendario de Fecha Grupo Despacho de Cecos y Proveedores"
   ClientHeight    =   9510
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   16980
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      MaxCols         =   0
      MaxRows         =   0
      SpreadDesigner  =   "M_Calendario_Fechas_GrupoDespacho.frx":0000
      StartingColNumber=   2
   End
   ...
   End
End
Attribute VB_Name = "M_Calendario_Fechas_GrupoDespacho"
...
MsgTitulo = "Calendario Grupo Despacho"
...
'       dia = UCase(Mid(WeekdayName(DatePart("w", Fd, vbUseSystemDayOfWeek)), 1, 1)) & vbCrLf & Day(Fd)
  ...
  'Busca los cecos que tienen fecha de Ruta de Despacho
    ...
    Sql = ""
    Sql = " sgpadm_sel_CalendarioRutaGrupoDespacho "
 ...
 '      .MaxRows = RS.RecordCount
      ...
      Do While Not RS.EOF
        ...
        If RS("marca") = True Then
          ...
          .Col = 4 ' Rut Proveedor
          .text = IIf(IsNull(RS("Proveedor")), " ", RS("Proveedor"))
   
          .Col = 5 'Proveedor
          .text = IIf(IsNull(RS("NomProveedor")), " ", RS("NomProveedor"))
          
          .Col = 6 'Grupo Despacho
          .text = IIf(IsNull(RS("IdGrupoDespacho")), " ", RS("IdGrupoDespacho") & " " & RS("NomGrupoDespacho"))
          .TypeHAlign = TypeHAlignLeft
          
          fecha_despacho = Mid(RS("FechaDespacho"), 7, 2) + "/" + Mid(RS("FechaDespacho"), 5, 2) + "/" + Mid(RS("FechaDespacho"), 1, 4) 'dd/mm/yyyy
