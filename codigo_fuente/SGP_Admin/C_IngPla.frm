...
Do While Not RS1.EOF
   ...
   vaSpread1(0).Lock = True
   vaSpread1(0).TypeHAlign = TypeHAlignLeft
   vaSpread1(0).text = IIf(IsNull(RS1!ing_codigo), "", " " & RS1!ing_codigo)
   ...
   vaSpread1(0).Lock = True
   vaSpread1(0).TypeHAlign = TypeHAlignLeft
   vaSpread1(0).text = Trim(IIf(IsNull(RS1!pro_codigo), "", " " & RS1!pro_codigo))
   ...
   vaSpread1(0).ForeColor = IIf(RS1!dlp_precio = 0 Or IsNull(RS1!dlp_precio), &HFF&, &HFF0000)
