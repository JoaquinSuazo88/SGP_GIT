...
Case 4
    ...
    i = 65: X = 64: j = 1: texcol = "": z = 65
    Do Until j > vaSpread1.maxcols
       If j = vaSpread1.maxcols Then
          texcol = Trim(texcol & Chr(i))
          Exit Do
       End If
       i = i + 1: j = j + 1: z = z + 1
       If i = 90 Then
          i = 65: X = X + 1: texcol = Chr(X)
       End If
    Loop
    If texcol = "A" Or texcol = "" And vaSpread1.maxcols > 1 Then texcol = "": texcol = Chr(z)
