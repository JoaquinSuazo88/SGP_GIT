...
Begin VB.Form P_CambioCarro 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cambio de Carro"
   ClientHeight    =   3570
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10995
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image1 
         ...
         Index           =   0
         Left            =   3285
         Picture         =   "P_CambioCarro.frx":0000
         Top             =   240
         Width           =   480
      End
      Begin VB.Label Label2 
      ...
      Begin VB.Image Image1 
         ...
         Index           =   1
         Left            =   3270
         Picture         =   "P_CambioCarro.frx":030A
         Top             =   1140
         Width           =   480
      End
   ...
   End
End
Attribute VB_Name = "P_CambioCarro"
...
Case 0
    ...
    If lc_Aux = "P_CambioCarro" Then
        
        Sql = Sql & " '" & 2 & "' "
        Set RS = vg_db.Execute("ValidarPedidos_02 " & Sql & "")
        If RS.EOF Then
            MsgBox "No existe pedido proyectado modificar ...", vbExclamation + vbOKOnly, Me.Caption
            RS.Close
            Set RS = Nothing
            Exit Sub
        End If
    ...
    Else
        ...
        Sql = Sql & " '" & 97 & "' "
        Set RS = vg_db.Execute("ValidarPedidos_03 " & Sql & "")
        If RS.EOF Then
            MsgBox "No existe pedido con estado descarga minuta ...", vbExclamation + vbOKOnly, Me.Caption
            RS.Close
            Set RS = Nothing
            Exit Sub
        End If
    ...
    If lc_Aux = "P_CambioCarro" Then
       ...
       Sql = Sql & " " & fpLongInteger1(0).Value & ", "
       Sql = Sql & " '" & LimpiaDato(Trim(fpText1.text)) & "' , "
       Sql = Sql & " " & IIf(Option1(0).Value = True, 3, 1) & ", "
       Sql = Sql & " '" & UCase(LimpiaDato(Trim(vg_NUsr))) & "' "
       
       Set RS = vg_db.Execute("sgpadm_Upd_CambiarEstadoPedidoProyCDPAP " & Sql & "")
    ...
    Else
       ...
       Sql = Sql & " " & fpLongInteger1(0).Value & ", "
       Sql = Sql & " '" & LimpiaDato(Trim(fpText1.text)) & "' , "
       Sql = Sql & " " & IIf(Option1(0).Value = True, 1, IIf(Option1(1).Value = True, 2, 3)) & ", "
       Sql = Sql & " '" & UCase(LimpiaDato(Trim(vg_NUsr))) & "' "
       
       Set RS = vg_db.Execute("sgpadm_Upd_CambiarEstadoPedido " & Sql & "")
...
If Trim(fpLongInteger1(0).text) = "" Then
    Call MsgBox("Debe Ingresar NºPedido", vbInformation, Me.Caption)
...
If lc_Aux = "P_CambioCarro" Then
   ...
   Me.Caption = "Actualizar Cambio de pedido proyectado a CD o PAP"

   Option1(0).Caption = "CD"
   Option1(1).Caption = "PAP"
   Option1(2).Visible = False
   
Else

   Me.Caption = "Actualizar Cambio de pedido"

   Option1(0).Caption = "Generado"
   Option1(1).Caption = "Enviado Minuta a Sitio"
   Option1(2).Caption = "Generado con Error"
