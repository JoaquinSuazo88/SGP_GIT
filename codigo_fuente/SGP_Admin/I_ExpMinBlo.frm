...
Begin VB.Form I_ExpMinBlo 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CheckBox Check7 
         Caption         =   "Generar Reporte por Lotes"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.OptionButton Option1 
         Caption         =   "Permite habilitar la columna % Ponderaciones"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.OptionButton Option1 
         Caption         =   "Permite habilitar la columna Raciones"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin FPSpread.vaSpread vaSpread2 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "I_ExpMinBlo.frx":0000
      End
      Begin VB.CheckBox Check5 
         Caption         =   "Incluye Recetas"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CheckBox Check4 
         Caption         =   "No aplicar código receta"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.CheckBox Check3 
         Caption         =   "Aplicar formula porcentaje"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         EndProperty
         MaxCols         =   9
         SpreadDesigner  =   "I_ExpMinBlo.frx":01FE
      End
...
Set Rs_Receta = vg_db.Execute("sgpadm_Sel_XMLResumenCostoReceta_Excel_V03 '" & Ceco & "', " & regimen & ", 10001, " & Format(Fecha, "yyyymmdd") & ", 1, '1', '" & XmlDietetica & "', '" & XmlPlato & "', '" & Format(FpFecDesde.text, "ddmm") & "', '" & Format(FpFecHasta.text, "ddmm") & "'")
