...
Begin VB.Form B_RecMBi 
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      SpreadDesigner  =   "B_RecMbi.frx":0614
      VisibleCols     =   3
      VisibleRows     =   20
      ScrollBarTrack  =   3
   End
...
' Control displays text tips aligned to pointer with focus
    ...
    RS.CursorLocation = adUseClient
    vg_db.CursorLocation = adUseClient
    Set RS = vg_db.Execute("sgpadm_Sel_ResumenCostoReceta_V04 '" & vg_codcasino & "', " & vg_codregimen & ", " & vg_codservicio & ", " & FilCatDie & ", " & FilTipPla & ", " & Fecha & ", " & SeleccionOpt & ", '" & IIf(IncluirColCosto.Value = 1, 1, 0) & "'")
    vaSpread1.MaxRows = 0
