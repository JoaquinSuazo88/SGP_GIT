...
Begin VB.Form E_CostoMermaSitio 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Costo Merma Sitio"
   ClientHeight    =   8790
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14610
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         EndProperty
         MaxCols         =   9
         SpreadDesigner  =   "E_CostoMermaSitio.frx":0000
      End
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "E_CostoMermaSitio.frx":1AA0
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "E_CostoMermaSitio"
...
If Option1(0).Value = True Then
   ...
   Set RS = vg_db.Execute("sgpadm_Sel_XmlCostoMermaSitioDetallado '" & MyBuffer & "', " & Format(FpFecDesde.text, "yyyymmdd") & ", " & Format(FpFecHasta.text, "yyyymmdd") & "")

ElseIf Option1(1).Value = True Then

   Set RS = vg_db.Execute("sgpadm_Sel_XmlCostoMermaSitioResumido '" & MyBuffer & "', " & Format(FpFecDesde.text, "yyyymmdd") & ", " & Format(FpFecHasta.text, "yyyymmdd") & "")
...
Dim Sql As String
    ...
    Case 1 'Mostrar datos en la grilla
        ...
        Set RS = vg_db.Execute("sgpadm_Sel_ListarCostoMermaSitios " & Sql & "")
        Do While Not RS.EOF
