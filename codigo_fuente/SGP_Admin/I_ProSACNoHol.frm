...
Begin VB.Form I_ProSACNoHol 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Productos no Homologados"
   ClientHeight    =   2160
   ClientLeft      =   5655
   ClientTop       =   2295
   ClientWidth     =   10005
   ...
   Begin VB.Image Image1 
      ...
      Index           =   2
      Left            =   3120
      Picture         =   "I_ProSACNoHol.frx":0000
      Top             =   880
      Width           =   480
   End
   ...
   Begin VB.Image Image1 
      ...
      Index           =   1
      Left            =   3120
      Picture         =   "I_ProSACNoHol.frx":030A
      Top             =   510
      Width           =   480
   End
   Begin VB.Label fpayuda 
   ...
   End
End
Attribute VB_Name = "I_ProSACNoHol"
...
Select Case Index
Case 1
    RS.Open "sgpadm_s_cliente 19, '" & Trim(LimpiaDato(fpText(1).text)) & "', ''", vg_db, adOpenStatic
    If RS.EOF Then RS.Close: Set RS = Nothing: fpayuda(1).Caption = "": Exit Sub
    fpayuda(1).Caption = Trim(RS!cli_nombre)
    RS.Close: Set RS = Nothing
Case 2
    RS.Open "sgpadm_s_productossap 19, '" & Trim(LimpiaDato(fpText(2).text)) & "', ''", vg_db, adOpenStatic
    If RS.EOF Then RS.Close: Set RS = Nothing: fpayuda(2).Caption = "": Exit Sub
    fpayuda(2).Caption = Trim(RS!cli_nombre)
    RS.Close: Set RS = Nothing
End Sub
