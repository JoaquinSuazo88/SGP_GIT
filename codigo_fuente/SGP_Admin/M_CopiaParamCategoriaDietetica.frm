...
Begin VB.Form M_CopiaParamCategoriaDietetica 
   Caption         =   "Copiar Parametro Categoria Dietetica"
   ClientHeight    =   7530
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   10725
   ...
   Begin VB.Frame Frame2 
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         EndProperty
         MaxCols         =   5
         SpreadDesigner  =   "M_CopiaParamCategoriaDietetica.frx":0000
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image1 
         ...
         Index           =   0
         Left            =   2400
         Picture         =   "M_CopiaParamCategoriaDietetica.frx":1918
         Top             =   360
         Visible         =   0   'False
         Width           =   480
      End
   ...
   End
End
Attribute VB_Name = "M_CopiaParamCategoriaDietetica"
...
Select Case Index
    ...
    Case 0
        ...
        If MsgBox("Esta Seguro Copiar...", vbQuestion + vbYesNo, MsgTitulo) = vbNo Then
        ...
        Let MyBuffer = MyBuffer & "<CopiaParCatDie>"
        ...
        For i = 1 To vaSpread1.MaxRows
            ...
            If selecciona = 1 And vaSpread1.RowHidden = False Then
               ...
               MyBuffer = MyBuffer & " <CopiaParamCatDietDet"
        ...
        MyBuffer = MyBuffer & "</CopiaParCatDie>"
      
        If RS.State = 1 Then RS.Close
        RS.CursorLocation = adUseClient
        vg_db.CursorLocation = adUseClient

        Set RS = vg_db.Execute("sgpadm_Ins_XmlCopiaParamCategoriaDietetica_V01 '" & MyBuffer & "', '" & Trim(LimpiaDato(fpText.text)) & "', '" & UCase(LimpiaDato(Trim(vg_NUsr))) & "'")
...
Me.Width = 10965
fg_centra Me
MsgTitulo = "Copiar Parametro Categoria Dietetica"
TextDet2(2).text = ""
TextDet2(3).text = ""
...
Sub LlenarDatos(Ceco As String)
...
Set RS = vg_db.Execute("sgpadm_Sel_ValidarParametroCategoriaDietetica_V01 '" & Ceco & "'")
...
Set RS = vg_db.Execute("sgpadm_Sel_TraerSitiosCopiaParamCategoriaDietetica_V01 '" & Ceco & "'")
...
If Not RS.EOF Then
   ...
   Do While Not RS.EOF
      ...
      vaSpread1.Col = 4
      vaSpread1.text = IIf(RS!IdCeco <> "", "Existe datos parametro Categoria Dietetica", "")
