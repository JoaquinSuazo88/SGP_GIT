...
If modo = "A" Then
   ...
   Set RS = vg_db.Execute("SELECT gci_codigo FROM a_grupocambioing ORDER BY gci_codigo DESC")
   If Not RS.EOF Then
       
       RS.MoveFirst
       codigo = RS!gci_codigo + 1
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
     ...
     RS.CursorLocation = adUseClient
     vg_db.CursorLocation = adUseClient
     RS.Open "SELECT COUNT(distinct gci_codigo) as nreg FROM a_grupocambioing WHERE gci_codigo LIKE '%" & UCase(LimpiaDato(fpText1.text)) & "%'", vg_db, adOpenForwardOnly
     If RS.EOF Or RS!nReg = 0 Then vaSpread1.MaxRows = 0 Else vaSpread1.MaxRows = RS!nReg
     RS.Close: Set RS = Nothing
     If RS.State = 1 Then RS.Close
     RS.CursorLocation = adUseClient
     vg_db.CursorLocation = adUseClient
     RS.Open "SELECT gci_codigo, gci_nombre FROM a_grupocambioing WHERE gci_codigo LIKE '%" & UCase(LimpiaDato(fpText1.text)) & "%'", vg_db, adOpenForwardOnly
...
ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
     ...
     RS.CursorLocation = adUseClient
     vg_db.CursorLocation = adUseClient
     RS.Open "SELECT COUNT(distinct gci_codigo) AS NREG FROM a_grupocambioing WHERE UPPER(gci_nombre) LIKE '%" & UCase(LimpiaDato(fpText1.text)) & "%'", vg_db, adOpenForwardOnly
     If RS.EOF Or RS!nReg = 0 Then vaSpread1.MaxRows = 0 Else vaSpread1.MaxRows = RS!nReg
     RS.Close: Set RS = Nothing
     ...
     RS.CursorLocation = adUseClient
     vg_db.CursorLocation = adUseClient
     RS.Open "SELECT gci_codigo, gci_nombre FROM a_grupocambioing WHERE UPPER(gci_nombre) LIKE '%" & UCase(LimpiaDato(fpText1.text)) & "%'", vg_db, adOpenForwardOnly
...
If Not RS.EOF Then
   ...
   Do While Not RS.EOF
      ...
      vaSpread1.text = RS!gci_codigo
      
      vaSpread1.Col = 2
      vaSpread1.Lock = False
      vaSpread1.TypeHAlign = TypeHAlignLeft
      vaSpread1.text = IIf(IsNull(RS!gci_nombre), "", Trim(RS!gci_nombre))
      RS.MoveNext
...
RS.CursorLocation = adUseClient
vg_db.CursorLocation = adUseClient
Set RS = vg_db.Execute("SELECT gci_codigo, gci_nombre FROM a_grupocambioing ORDER BY gci_codigo")
Do While Not RS.EOF
    vaSpread1.MaxRows = vaSpread1.MaxRows + 1
    vaSpread1.Row = vaSpread1.MaxRows
    vaSpread1.Col = 1
    vaSpread1.Lock = True
    vaSpread1.text = IIf(IsNull(RS!gci_codigo), "", RS!gci_codigo)
...
RS.CursorLocation = adUseClient
vg_db.CursorLocation = adUseClient
Set RS = vg_db.Execute("SELECT * FROM a_grupocambioing WHERE gci_codigo=" & codigo & "")
If Not RS.EOF Then
