...
Begin VB.Form I_CoteRe 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         MaxCols         =   4
         MaxRows         =   100
         SpreadDesigner  =   "I_CoteRe.frx":030A
      End
...
Dim MsgTitulo As String, opcion As String
...
If opcion = "I" Then Set btnX = Toolbar1.Buttons.Add(, "A_Previa   ", , tbrDefault, "A_Previa   "): btnX.Visible = True: btnX.ToolTipText = "Vista Previa": btnX.Enabled = IIf(Mid(ValidarUsuario(Me), 4, 1) = "1", True, False)
...
Case 2
    ...
    B_MTaEst.LlenaDatos "Servicio", I_CoteRe.vaSpread1, fpText.Text, fpLongInteger1(0).Value, Val(Format(fpDateTime1(0).Text, "yyyymmdd")), Val(Format(fpDateTime1(1).Text, "yyyymmdd")), "1"
    B_MTaEst.Show 1
    Me.Refresh
    If vg_codigo = "" Then Exit Sub
End Select
...
Case 1
    ...
    If opcion = "I" Then
       I_CostoTeoricoReal fpText.Text, Val(fpLongInteger1(0).Value), Val(Format(fpDateTime1(0).Text, "yyyymmdd")), Val(Format(fpDateTime1(1).Text, "yyyymmdd")), "1", opnomrec
    ElseIf opcion = "G" Then
       isel = 0: codser = 0
       For i = 1 To vaSpread1.MaxRows
           vaSpread1.Row = i: vaSpread1.Col = 1
           If vaSpread1.Text = "1" Then vaSpread1.Col = 2: codser = vaSpread1.Text: isel = isel + 1
       Next i
       If isel > 1 Then codser = 0
       G_TeoRea.LlenarGrafico fpText.Text, Val(fpLongInteger1(0).Value), codser, Val(Format(fpDateTime1(0).Text, "yyyymmdd")), Val(Format(fpDateTime1(1).Text, "yyyymmdd"))
       G_TeoRea.Show 1
    End If
Case 3
