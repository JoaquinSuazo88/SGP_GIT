...
Do While Not RS1.EOF
   ...
   vaSpread1.Col = 1: vaSpread1.TypeHAlign = 2: vaSpread1.Text = Mid(RS1!ped_anomes, 5, 2) & "/" & Mid(RS1!ped_anomes, 1, 4)
   vaSpread1.Col = 2: vaSpread1.Text = IIf(RS1!ped_tipped = 2, "Adicionales", "Anulaciones")
   vaSpread1.Col = 3: vaSpread1.TypeHAlign = 2: vaSpread1.Text = Mid(RS1!ped_fecped, 7, 2) & "/" & Mid(RS1!ped_fecped, 5, 2) & "/" & Mid(RS1!ped_fecped, 1, 4)
   RS1.MoveNext
Loop
...
vaSpread1.Col = 1: vg_anomes = Val(Mid(vaSpread1.Text, 4, 4) & Mid(vaSpread1.Text, 1, 2))
vaSpread1.Col = 2: vg_tipped = Val(IIf(vaSpread1.Text = "Adicionales", 2, 3))
vaSpread1.Col = 3: vg_fecval = Val(Mid(vaSpread1.Text, 7, 4) & Mid(vaSpread1.Text, 4, 2) & Mid(vaSpread1.Text, 1, 2))
Cerrar
End Sub
