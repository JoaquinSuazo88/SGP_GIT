...
If Not RS1.EOF Then
    Do While Not RS1.EOF
        Combo1(1).AddItem RS1!aju_nombre & Space(150) & "(" & fg_pone_cero(Str(RS1!aju_codigo), 10) & ")"
        RS1.MoveNext
    Loop
End If
RS1.Close: Set RS1 = Nothing
...
On Local Error GoTo Error_Casino
vg_codigo = 0
Select Case Index
Case 1
...
Dim cFecini As String, cFecter As String, CodBod As Long, CodMer As Long, Cencos As String
Dim TipMer As String
On Local Error GoTo Error_Boton
If Combo1(0).ListIndex = -1 Then
    MsgBox "Seleccione bodega...", vbExclamation + vbOKOnly, Msgtitulo: Exit Sub
End If
If OptTipMer(0).Value = True Then
...
CodBod = fg_codigocbo(Combo1, 0, 10, 0)
