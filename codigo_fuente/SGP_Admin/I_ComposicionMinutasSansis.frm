...
Begin VB.Form I_ComposicionMinutasSansis 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image1 
         ...
         Index           =   0
         Left            =   3120
         Picture         =   "I_ComposicionMinutasSansis.frx":0000
         Top             =   120
         Width           =   480
      End
      Begin VB.Image Image1 
         ...
         Index           =   1
         Left            =   3120
         Picture         =   "I_ComposicionMinutasSansis.frx":030A
         Top             =   450
         Width           =   480
      End
      Begin VB.Label fpayuda 
   ...
   End
End
Attribute VB_Name = "I_ComposicionMinutasSansis"
