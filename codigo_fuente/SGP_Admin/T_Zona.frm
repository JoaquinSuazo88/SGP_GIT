...
If modo = "A" Then
    ...
    Set RS = vg_db.Execute("sgpadm_s_zona 2, 0,''")
    If Not RS.EOF Then RS.MoveFirst: codigo = RS!zon_codigo + 1 Else codigo = 1
    RS.Close
    Set RS = Nothing
    
    vg_db.Execute "INSERT INTO a_zona (zon_codigo, zon_nombre, zon_codlpr, zon_activo) " & _
                  "VALUES (" & codigo & ", '" & Trim(Nombre) & "', " & codlpr & ", '" & Activo & "')"
...
Else
    ...
    vg_db.Execute "UPDATE a_zona SET zon_nombre='" & Trim(Nombre) & "', zon_codlpr=" & codlpr & ", zon_activo = '" & Activo & "' WHERE zon_codigo=" & codigo & ""
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
   ...
   Set RS = vg_db.Execute("sgpadm_s_zona 3, 0,'%" & UCase(LimpiaDato(fpText1.text)) & "%'")

ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
   
   Set RS = vg_db.Execute("sgpadm_s_zona 4, 0,'%" & UCase(LimpiaDato(fpText1.text)) & "%'")
...
If Not RS.EOF Then
   ...
   Do While Not RS.EOF
      ...
      vaSpread1.Col = 2
      vaSpread1.text = IIf(IsNull(RS!Zon_nombre), "", Trim(RS!Zon_nombre))
      lisnom = ""
      liscod = ""
      ...
      If EstVect Then
         ...
         For z = 1 To UBound(vLisPre)
             ...
             vaSpread1.Col = 3
             lisnom = lisnom & IIf(lisnom <> "", Chr$(9), "") & Trim(vLisPre(z, 2))
             
             vaSpread1.Col = 4
             liscod = liscod & IIf(liscod <> "", Chr$(9), "") & vLisPre(z, 1)
      ...
      For z = 0 To vaSpread1.TypeComboBoxCount
          ...
          If vaSpread1.text = IIf(IsNull(RS!zon_codlpr), 0, RS!zon_codlpr) Then codaux = z: Exit For
          codaux = -1
...
If Not RS.EOF Then
   ...
   Do While Not RS.EOF
      ...
      vLisPre(i, 2) = IIf(IsNull(RS!lpr_nombre), "", RS!lpr_nombre)
      i = i + 1
...
vaSpread1.MaxRows = 0
Set RS = vg_db.Execute("sgpadm_s_zona 5, 0,''")
Do While Not RS.EOF
    ...
    For z = 0 To vaSpread1.TypeComboBoxCount
        ...
        If vaSpread1.text = IIf(IsNull(RS!zon_codlpr), 0, RS!zon_codlpr) Then
...
Set RS = vg_db.Execute("sgpadm_s_zona 1, " & codigo & ",''")
...
If Not RS.EOF Then
   ...
   vaSpread1.Col = 5
   vaSpread1.text = IIf(IsNull(RS!Zon_activo), "0", RS!Zon_activo)
