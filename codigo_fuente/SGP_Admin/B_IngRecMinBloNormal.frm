...
Begin VB.Form B_IngRecMinBloNormal 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Buscar Ingrediente & Receta Minuta Bloque Normal"
   ClientHeight    =   6555
   ClientLeft      =   7140
   ClientTop       =   3165
   ClientWidth     =   5325
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      MaxCols         =   4
      MaxRows         =   18
      SpreadDesigner  =   "B_IngRecMinBloNormal.frx":0000
      VisibleCols     =   2
      VisibleRows     =   18
      ScrollBarTrack  =   3
   End
   Begin FPSpread.vaSpread vaSpread2 
      ...
      MaxCols         =   3
      MaxRows         =   18
      SpreadDesigner  =   "B_IngRecMinBloNormal.frx":04B3
      VisibleCols     =   2
      VisibleRows     =   18
      ScrollBarTrack  =   3
   End
End
Attribute VB_Name = "B_IngRecMinBloNormal"
...
Else
   ...
   For i = 1 To Form1.vaSpread1.MaxRows
       ...
       For j = 3 To (Form1.vaSpread1.maxcols - 2) Step 7
           DoEvents
           CodigoReceta = 0
