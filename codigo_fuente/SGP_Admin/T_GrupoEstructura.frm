...
Begin VB.Form T_GrupoEstructura 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "T_GrupoEstructura.frx":0000
         Left            =   2010
         List            =   "T_GrupoEstructura.frx":000A
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      MaxCols         =   6
      ProcessTab      =   -1  'True
      SpreadDesigner  =   "T_GrupoEstructura.frx":001E
      ScrollBarTrack  =   3
      ClipboardOptions=   0
   End
End
Attribute VB_Name = "T_GrupoEstructura"
...
If modo = "A" Then
   ...
   codigo = 0
   Set RS = vg_db.Execute("sgpadm_Ins_GrupoEstructura '" & Trim(Nombre) & "', '" & vg_NUsr & "'")
   If Not RS.EOF Then
...
Else
   ...
   'validar la desactivación grupo estructura
   If Activo = "0" Then
      ...
      Set RS = vg_db.Execute("EXEC SGPADM_Sel_ValidaBorradoGrupoEstructura " & codigo & "")
      ...
      If Not RS.EOF Then
         ...
         If RS!Retorno = 1 Then
            ...
            MsgBox "El grupo estructura  no se puede desactivar, ya que fue utilizado dentro de los últimos " & GetParametro("inacgesini") & " meses o " & GetParametro("inacgesfin") & " meses posteriores a la fecha actual...", vbExclamation + vbOKOnly, MsgTitulo
            vaSpread1.Row = Fila
            vaSpread1.Col = 12
   ...
   Set RS = vg_db.Execute("sgpadm_Sel_CodigoGrupoEstructura " & codigo & "")
   If Not RS.EOF Then
       
      MensajeAnterior = codigo & ";" & IIf(IsNull(RS!Nombre), "", Trim(RS!Nombre)) & ";" & IIf(IsNull(RS!Activo), "", Trim(RS!Activo)) & ";" & vg_NUsr
   ...
   Set RS = vg_db.Execute("sgpadm_Upd_GrupoEstructura " & codigo & ", '" & Trim(Nombre) & "', '" & Activo & "', '" & vg_NUsr & "'")
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
   ...
   Set RS = vg_db.Execute("sgpadm_Sel_BuscarCodigoGrupoEstructura '%" & UCase(LimpiaDato(fpText1.text)) & "%'")

ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
    
   Set RS = vg_db.Execute("sgpadm_Sel_BuscarNombreGrupoEstructura '%" & UCase(LimpiaDato(fpText1.text)) & "%'")
...
If Not RS.EOF Then
   ...
   Do While Not RS.EOF
      ...
      vaSpread1.Value = RS!IdGrupoEstructura
...
Case 5
   ...
   'validar la desactivación grupo estructura
    ...
    Set RS = vg_db.Execute("sgpadm_Del_GrupoEstructura " & codigo & ", '0', '" & vg_NUsr & "'")
...
Set RS = vg_db.Execute("sgpadm_Sel_GrupoEstructura")
