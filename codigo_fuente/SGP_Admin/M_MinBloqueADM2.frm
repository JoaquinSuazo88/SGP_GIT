...
Begin VB.Form M_MinBloqueADM2 
   Appearance      =   0  'Flat
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Minuta Bloque ADM"
   ClientHeight    =   7860
   ClientLeft      =   2430
   ClientTop       =   2490
   ClientWidth     =   14040
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Image Image1 
            ...
            Index           =   2
            Left            =   120
            Picture         =   "M_MinBloqueADM2.frx":0000
            Top             =   150
            Visible         =   0   'False
            Width           =   480
         End
      ...
      Begin VB.Image Image2 
         ...
         Index           =   0
         Left            =   2760
         Picture         =   "M_MinBloqueADM2.frx":030A
         Stretch         =   -1  'True
      ...
      Begin VB.Image Image2 
         ...
         Index           =   1
         Left            =   3360
         Picture         =   "M_MinBloqueADM2.frx":0614
         Stretch         =   -1  'True
   ...
   Begin FPSpread.vaSpread vaSpread1 
      DragIcon        =   "M_MinBloqueADM2.frx":091E
      Height          =   3015
      Left            =   -90
      TabIndex        =   8
      Top             =   2040
      ...
      Protect         =   0   'False
      RestrictRows    =   -1  'True
      SpreadDesigner  =   "M_MinBloqueADM2.frx":0D60
      UserResize      =   1
      VisibleCols     =   1
      VisibleRows     =   1
      TextTip         =   2
   ...
   Begin VB.Menu Main 
      ...
      End
      Begin VB.Menu Plato 
         Caption         =   "Cambiar &Cat. Dietetica"
         Index           =   17
      End
      Begin VB.Menu Plato 
         Caption         =   "Cambiar &Tipo Plato"
         Index           =   18
      End
   End
   Begin VB.Menu Main 
   ...
   Begin VB.Menu MenuDetalle 
      ...
      End
      Begin VB.Menu OpGrilla 
         Caption         =   "Cambiar &Categoria Dietetica"
         Index           =   17
      End
      Begin VB.Menu OpGrilla 
   ...
   End
End
Attribute VB_Name = "M_MinBloqueADM2"
...
Case 10
     ...
     If vaSpread1.Col = 1 Or vaSpread1.Col = 2 Or vaSpread1.Col = 3 Or vaSpread1.Col = 4 Or vaSpread1.Col = 5 Then Exit Sub
     j = 0
     ...
     Call C_ApoPla.LlenarApoPlan(M_MinBloqueADM2, "Aporte Planificación Teórica " & vaSpread1.text, vg_codcasino, vg_codregimen, vg_codservicio, Val(Vg_FechaDesde), 1, j)
     C_ApoPla.Show 1, Me
...
Case 20
     ...
     If vaSpread1.Col = 1 Or vaSpread1.Col = 2 Or vaSpread1.Col = 3 Or vaSpread1.Col = 4 Or vaSpread1.Col = 5 Then
     ...
     Let VarSitioRemoto = True
     Call C_AporteSansis.LlenarApoPlan(M_MinBloqueADM2, "Aporte Planificación Bloque " & vaSpread1.text, vg_codcasino, vg_codregimen, vg_codservicio, Val(FechaGrilla), 1, j)
...
Else
    ...
    For i = 6 To (vaSpread1.maxcols - 4) Step 7
...
'codigo estructura
vaSpread1.Col = vaSpread1.maxcols - 3
...
Estructura1.item(Index).Enabled = False
Estructura2.item(Index).Enabled = False
...
On Error GoTo Man_Error
    ...
    If RowGrupoMin > 0 Then
       ...
       For i = RowGrupoMin To vaSpread1.MaxRows - 1
           ...
           'codigo grupo estructura
           vaSpread1.Col = vaSpread1.maxcols - 2
...
Dim RS1     As New ADODB.Recordset
    ...
    Set BtnX = Toolbar1.Buttons.Add(, , "", tbrSeparator, 0): BtnX.Enabled = False
   ' Set BtnX = Toolbar1.Buttons.Add(, "A_ExportaPlanif", , tbrDefault, "A_ExportaPlanif"): BtnX.Visible = False: Me.HelpContextID = 1032000: BtnX.Enabled = IIf(Mid(ValidarUsuarioAcceso(M_MinBloqueADM2), 1, 1) = "0", False, True): BtnX.ToolTipText = IIf(Mid(ValidarUsuarioAcceso(M_MinBloqueADM2), 1, 1) = "0", "", "Exportar Planificación Teórica")
'    Set BtnX = Toolbar1.Buttons.Add(, "A_ImportaPlanif", , tbrDefault, "A_ImportaPlanif"): BtnX.Visible = False: Me.HelpContextID = 1034000: BtnX.Enabled = IIf(Mid(ValidarUsuarioAcceso(M_MinBloqueADM2), 1, 1) = "0", False, True): BtnX.ToolTipText = IIf(Mid(ValidarUsuarioAcceso(M_MinBloqueADM2), 1, 1) = "0", "", "Importar Planificación")
...
If Estructura1(0).Visible = False Then

   Estructura1(0).Visible = True
   Estructura2(0).Visible = True
...
If Not RS.EOF Then
       ...
       Do While Not RS.EOF
          ...
          For i = 1 To vaSpread1.MaxRows
              ...
              'columna codigo estructura servicio
              vaSpread1.Col = vaSpread1.maxcols - 3
    ...
    Select Case Index
        ...
        Case 5 '-------> Ver detalle recetas
            ...
            If xcol <= 0 Then
               ...
               MsgBox "Debe seleccionar la columna de receta", vbCritical + vbOKOnly, MsgTitulo
               Exit Sub
            ...
            Let VarSitioRemoto = True
            vaSpread1.Col = xcol
            vaSpread1.SetActiveCell xcol, vaSpread1.Row
...
'            CmdCerrar.Left = 19900
            ...
            Set RS = vg_db.Execute("sgpadm_Sel_TraerConceptoLyDMinutaBloque_V01 " & vg_codservicio & "")
            If Not RS.EOF Then
...
'            Let VarSitioRemoto = False
        ...
        Case 20 '-------> Salir de planificación
            ...
            If MsgBox(" Actualiza planificación teórica...", vbQuestion + vbYesNo, MsgTitulo) = vbNo Then
            ...
            If IndGrabado = 1 Then
               ...
               'cancela el cerrado por encontrase validación sin ajustar
               If IndGrabado = 1 Then
...
'Fila Maestra de Grupo
    ...
    Select Case Index
        ...
        Case 2 '-------> Ingresar recetas
            ...
            aiblockcol = vaSpread1.ActiveCol
            iblockcol2 = vaSpread1.ActiveCol
            aiblockcol2 = vaSpread1.ActiveCol
            iblockrow = vaSpread1.ActiveRow
            aiblockrow = vaSpread1.ActiveRow
            iblockrow2 = vaSpread1.ActiveRow
            aiblockrow2 = vaSpread1.ActiveRow
            vaSpread1.Row = vaSpread1.ActiveRow
            vaSpread1.Col = vaSpread1.ActiveCol
            ...
            For i = 1 To MaxColumna
                ...
                If vaSpread1.Col = vectorcol(i) Then
            ...
            'mover codigo categoria dietetica
            vaSpread1.Col = vaSpread1.maxcols - 1
            vaSpread1.Row = vaSpread1.ActiveRow
            vg_filcatdieMin = Val(vaSpread1.text)
            
            If vg_filcatdieMin = 0 And vaSpread1.Row > 1 Then
            ...
            'mover codigo tipo plato
            vaSpread1.Col = vaSpread1.maxcols
            vaSpread1.Row = vaSpread1.ActiveRow
            vg_filtipplaMin = Val(vaSpread1.text)
                        
            If vg_filtipplaMin = 0 And vaSpread1.Row > 1 Then
            ...
            AadRec = 0
            Let VarSitioRemoto = True
            B_RecMinutaBloqueAMD.Show 1, Me
            Let VarSitioRemoto = False
           ...
           'FIN ARI
            ...
            If Trim(vg_codigo) = "" Or Trim(vg_nombre) = "" Then
            ...
            Set RS = vg_db.Execute("sgpadm_Sel_ResumenCostoxReceta '" & vg_codcasino & "', " & vg_codregimen & ", " & vg_codservicio & ", " & vg_codigo & ", " & FechaDia & ", " & SeleccionOpt & "")
            If Not RS.EOF Then
...
'               End If
                ...
                For i = 6 To (vaSpread1.maxcols) Step 7
...
'               Exit Sub
            ...
            ElseIf Not TipoMinuta Then
               ...
               If (xColIni = 1 Or xColIni = 2 Or xColIni = 3 Or xColIni = 4 Or xColIni = 5) Then
        ...
        Case 8 '-------> Subir linea
            ...
            vaSpread1.Row = vaSpread1.ActiveRow
            vaSpread1.Col = vaSpread1.ActiveCol
            If vaSpread1.Row = 1 Or vaSpread1.Col = 3 Or vaSpread1.Col = 4 Or vaSpread1.Col = 5 Or vaSpread1.Row = vaSpread1.MaxRows Then Exit Sub  'jpaz
            ...
            If vaSpread1.Col > 1 Then
                ...
                If vaSpread1.MaxRows > 1000 Then
                
                   Del_Row = vaSpread1.MaxRows - 1000
...
'
        ...
        Case 9 '-------> Bajar linea
            ...
            vaSpread1.Row = vaSpread1.ActiveRow
            vaSpread1.Col = vaSpread1.ActiveCol
            If vaSpread1.Row = vaSpread1.MaxRows Or vaSpread1.Col = 3 Or vaSpread1.Col = 4 Or vaSpread1.Col = 5 Then Exit Sub
...
'            If vaSpread1.ActiveRow = vaSpread1.MaxRows Then Exit Sub
            If Index = 11 Then
               ...
               For i = 1 To MaxColumna
                   ...
                   If (vectorcol(i) - 2) = iblockcol Or vectorcol(i) = iblockcol Then
        ...
        Case 13, 14 'Validar recetas 5 etapas
            ...
            If aiblockcol2 = vaSpread1.maxcols Then
               ...
               aiblockcol2 = vaSpread1.maxcols - 4
            
            End If
            
            vaSpread1.Row = 0
            vaSpread1.Col = vaSpread1.ActiveCol 'iblockcol
            vaSpread1.Row = SpreadHeader + 3 '0
...
'                CantCol1 = iblockcol2 - iblockcol
            ...
            If Index = 14 And indcortarpegar = 1 Then
               ...
               For i = 7 To vaSpread1.maxcols - 4 Step 7
...
'                                  vaSpread1.TypeIntegerMax = 9999999
                                  ...
                                  vaSpread1.TypeIntegerSpinWrap = False
                                   ...
                                   'codigo grupo estructura servicio
                                   vaSpread1.Col = vaSpread1.maxcols - 2
                       ...
                       If L > 0 Then
                          ...
                          For L = 6 To (vaSpread1.maxcols - 4) Step 7
...
'                   (vectorcol(i) + 3) = iblockcol2 Or (vectorcol(i) + 4) = iblockcol2 Or (vectorcol(i) + 5) = iblockcol2 Then
'
'                       IColIni = ((vectorcol(i))): Exit For
'
'                End If
'
'           Next i

'           For i = IColIni To (vaSpread1.maxcols - 4) Step 1
'
'             Call vaSpread1.GetText(i, SpreadHeader + 3, dato)
'
'             If "N.Rac." = dato Then
'
'                IColBusca = (i - 1)
...
'           CalctodiaEnc vaSpread1.ActiveRow, IColBusca '1, i + 1
        ...
        Case 15
            ...
            B_IngRecMinBlo.Partidas Me
            B_IngRecMinBlo.Show 1
...
'20211209            Set RS = Nothing
            ...
            If vaSpread1.ActiveCol = 2 And vaSpread1.ActiveRow <> vaSpread1.MaxRows And Trim(vaSpread1.text) <> "" Then '20211209 And tipoceco = "1" Then
        ...
        Case 17 'Categoria dietetica
           ...
           'mover descripcion categoria dietetica
            vaSpread1.Row = vaSpread1.ActiveRow
            vaSpread1.Col = vaSpread1.ActiveCol
            vaSpread1.text = vg_nombre
        ...
        Case 18 'Tipo de Plato
           ...
           'mover descripcion tipo plato
            vaSpread1.Row = vaSpread1.ActiveRow
            vaSpread1.Col = vaSpread1.ActiveCol
            vaSpread1.text = vg_nombre
                       
            'mover codigo tipo de plato
            vaSpread1.Col = vaSpread1.maxcols
            vaSpread1.text = Val(vg_codigo)
...
On Error GoTo Man_Error
    ...
    'desactivar categoria ditetica
    Plato(16).Enabled = False
    OpGrilla(16).Enabled = False
    
    'desactivar categoria ditetica
    Plato(17).Enabled = False
    OpGrilla(17).Enabled = False
    
    'desactivar tipo de plato
    Plato(18).Enabled = False
    OpGrilla(18).Enabled = False
    ...
    Select Case Col
        ...
        Case 2
           ...
           'activar estructura servicio
           Plato(16).Enabled = True
           OpGrilla(16).Enabled = True
        ...
        Case 3
            ...
            'activar categoria dietetica
            Plato(17).Enabled = True
            OpGrilla(17).Enabled = True
        
        Case 4
        
            'activar tipo de plato
            Plato(18).Enabled = True
            OpGrilla(18).Enabled = True
...
If Row < 1 Or Col = 1 Or Col = 2 Or Col = 3 Or Col = 4 Or Col = 5 Then Exit Sub
...
If vaSpread1.Col <> 5 And Col <> 5 Then
   ...
   'If Toolbar1.Buttons(2).Enabled = False Then Exit Sub
    ...
    If vaSpread1.ChangeMade = False Or Col = 1 Or Col = 2 Or Col = 3 Or Col = 4 Then
    ...
    If vaSpread1.ChangeMade = True And Mode = 0 Then
       ...
       If indcos = True Then
          ...
          Else
             ...
             If (Col <> 1 And Col <> 2 And Col <> 3 And Col <> 4 And Col <> 5) Then
                vaSpread1.Row = vaSpread1.ActiveRow
                vaSpread1.Col = Col - 1
                LyD = False
...
ElseIf Col = 5 And vaSpread1.ChangeMade = True And Mode = 0 Then
    
    GrabarCambios 1, 1, "% Total"
    TipoCopia = ""
    
    Call Cal_PorSugerido_Raciones(Row, 4)
    
'    CodGrupoEst = 0
'    'rescatar codigo grupo estructura
'    vaSpread1.Row = Row
'    vaSpread1.Col = vaSpread1.maxcols - 2
'
'    If Trim(vaSpread1.text) <> "" And Val(vaSpread1.text) > 0 Then
'
'       CodGrupoEst = vaSpread1.text
'
'    Else
'
'      Exit Sub
...
'    End If
'
'    For j = Row To vaSpread1.MaxRows - 1
'
'        IrowT = j
'
'        For i = 7 To vaSpread1.maxcols - 4 Step 7
...
'            Call Cal_PorSugerido_Raciones(IrowT, icol)
'
'        Next i
'
'    Next j
...
Dim zrow          As Long
    ...
    Select Case KeyCode
        ...
        Case 46
            ...
            vaSpread1.Row = vaSpread1.ActiveRow
            vaSpread1.Col = vaSpread1.ActiveCol
            If vaSpread1.Col = 2 Then 'Suprimir estructura servicio
...
'validar que no vaya calcular costo cuando las columnas son 1 hasta 5
If vaSpread1.MaxRows < 1 Or NewCol = 1 Or NewCol = 2 Or NewCol = 3 Or NewCol = 4 Or NewCol = 5 Then
...
Dim CodCatReceta        As Long
Dim CodTipReceta        As Long
Dim AuxCodigoAgrupacion As Long
Dim TotPorcentaje       As Long

Dim NomGrupo            As String
Dim AuxNomGrupo         As String

Dim FechaDia            As String

Dim RowGrupo            As Long

Dim ValidaGrupoEstr     As Boolean
Dim ValidaCatDiet       As Boolean
Dim ValidaTipPla        As Boolean
Dim ValidaPorTotal      As Boolean
Dim ValidaPorDetalle    As Boolean
...
Dim ValidarCampoGrupoEstructuraServicio As Boolean
Dim ValidarCampoCategoriaDietetica      As Boolean
Dim ValidarCampoTipoPlato               As Boolean
Dim ValidarCampoPorGrupoGeneral         As Boolean

Dim PorcentajeGrupoTotal                As Long
Dim AuxPorcentajeGrupoTotal             As Long
Dim PorcentajeGrupoDia                  As Long

ValidarCampoGrupoEstructuraServicio = ValidarCampo("vgestmmib")
ValidarCampoCategoriaDietetica = ValidarCampo("vcdietmmib")
ValidarCampoTipoPlato = ValidarCampo("vtpltommib")
ValidarCampoPorGrupoGeneral = ValidarCampo("vporgmmib")

'mover estado de grabado a cero
IndGrabado = 0
        
'ini : validar grupo estructura servicio - categoria dietetica - tipo de plato
If Not TipoMinuta And (ValidarCampoGrupoEstructuraServicio Or ValidarCampoCategoriaDietetica Or ValidarCampoTipoPlato) Then
    
    ValidaGrupoEstr = True
    ValidaCatDiet = True
    ValidaTipPla = True
    ValidaPorTotal = True
    ValidaPorDetalle = True
    
    AuxCodigoAgrupacion = 0
    TotPorcentaje = 0
    NomGrupo = ""
    FechaDia = ""
    ...
    For i = 6 To (vaSpread1.maxcols - 4) Step 7
        ...
        For j = 1 To vaSpread1.MaxRows - 1
            ...
            If Trim(vaSpread1.text) <> "" Then
               ...
               NomGrupo = IIf(Trim(vaSpread1.text) <> "", vaSpread1.text, "")

            End If
            
            'porcentaje x grupo
            PorcentajeGrupoTotal = 0
            vaSpread1.Col = 5
            PorcentajeGrupoTotal = IIf(Trim(vaSpread1.text) <> "", Val(vaSpread1.text), -1)
               
            RowGrupo = j
                         
            If PorcentajeGrupoTotal = 0 And ValidarCampoPorGrupoGeneral Then
               
               ValidaPorTotal = False
               Exit For
            ...
            If Trim(DescReceta) <> "" And CodReceta > 0 Then
            
               'codigo grupo estructura servicio
               CodigoAgrupacion = 0
               vaSpread1.Col = vaSpread1.maxcols - 2
               CodigoAgrupacion = Val(vaSpread1.text)
               
               If CodigoAgrupacion < 1 And ValidarCampoGrupoEstructuraServicio Then
               
                  ValidaGrupoEstr = False
                  Exit For
                  
               End If
   
               'codigo categoria dietetica
               CodCatReceta = 0
               vaSpread1.Col = vaSpread1.maxcols - 1
               CodCatReceta = Val(vaSpread1.text)
               
               If CodCatReceta < 1 And ValidarCampoCategoriaDietetica Then
               ...
               CodTipReceta = 0
               vaSpread1.Col = vaSpread1.maxcols
               CodTipReceta = Val(vaSpread1.text)
               
               If CodTipReceta < 1 And ValidarCampoTipoPlato Then
            ...
            If CodReceta > 0 Then
            'validar si % por receta > % total del grupo
            If AuxCodigoAgrupacion <> CodigoAgrupacion And AuxCodigoAgrupacion > 0 And ValidarCampoPorGrupoGeneral Then
               
               If TotPorcentaje > AuxPorcentajeGrupoTotal And PorcentajeGrupoTotal > -1 Then
                  
            
                  Call MsgBox("El día : " & FechaDia & ", la sumatoria sobrepasa : " & TotPorcentaje & "%" & ", del grupo est. " & AuxNomGrupo & " corresponde: " & AuxPorcentajeGrupoTotal & "%" & ". proceso cerrar cancelado...", vbCritical + vbOKOnly, MsgTitulo)
                     
                  vaSpread1.SetActiveCell i + 2, vaSpread1.Row
                  vaSpread1.SetFocus
                     
                  IndGrabado = 1
                  ValidaPorDetalle = False
            ...
            If PorcenDiario > 0 And ValidarCampoPorGrupoGeneral Then

               TotPorcentaje = TotPorcentaje + PorcenDiario
            
            End If
            
            'mover codigo agrupacion a codigo auxilar
            AuxCodigoAgrupacion = CodigoAgrupacion

            'sacar dia
            Call vaSpread1.GetText(i + 1, SpreadHeader + 3, dato)
            FechaDia = dato
 
            'mover % grupo a % grupo auxilar
            If PorcentajeGrupoTotal > -1 Then
                  
               AuxPorcentajeGrupoTotal = PorcentajeGrupoTotal
               
            End If
               
            'mover nombre grupo a % grupo auxilar
            If NomGrupo <> "" Then
                  
               AuxNomGrupo = NomGrupo
        ...
        If Not ValidaGrupoEstr Or Not ValidaCatDiet Or Not ValidaTipPla Or Not ValidaPorTotal Or Not ValidaPorDetalle Then
    ...
    If Not ValidaGrupoEstr Then

       Call MsgBox("Debe estar definido grupo estructura servicio. proceso cerrar cancelado...", vbCritical + vbOKOnly, MsgTitulo)
       IndGrabado = 1
   
    End If

    If Not ValidaCatDiet Then

       Call MsgBox("Debe estar definido categoria dietetica. proceso cerrar cancelado...", vbCritical + vbOKOnly, MsgTitulo)
       IndGrabado = 1
   
    End If

    If Not ValidaTipPla Then

       Call MsgBox("Debe estar definido tipo de plato. proceso cerrar cancelado...", vbCritical + vbOKOnly, MsgTitulo)
       IndGrabado = 1
   '   Exit Sub
    ...
    If Not ValidaPorTotal Then

       Call MsgBox("El grupo estructura " & NomGrupo & ", su % esta con valor cero. proceso cerrar cancelado...", vbCritical + vbOKOnly, MsgTitulo)
       IndGrabado = 1
   '   Exit Sub
   
    End If
    
    If Not ValidaPorDetalle Then
...
'fin : validar grupo estructura servicio - categoria dietetica - tipo de plato
...
'                End If
                ...
                If Trim(vaSpread1.text) <> "" Then
                   ...
                   CodigoAgrupacion = IIf(Val(vaSpread1.text) = 0, 0, vaSpread1.text)
...
'                   vg_tiprec = vaSpread1.GetColFromID("Grupo") + 1
                ...
                If Trim(vaSpread1.text) <> "" Then
                   ...
                   CodCatReceta = IIf(Val(vaSpread1.text) = 0, 0, vaSpread1.text)
                
                End If
                
                'Codigo tipo de plato
                vaSpread1.Col = vaSpread1.maxcols
                                                
                If Trim(vaSpread1.text) <> "" Then
                
                   CodTipReceta = IIf(Val(vaSpread1.text) = 0, 0, vaSpread1.text)
                ...
                If Trim(DescReceta) <> "" And CodEstructura > 0 Then
                   ...
                   MyBuffer = MyBuffer & " CD = " & Chr(34) & CodCatReceta & Chr(34)
                   MyBuffer = MyBuffer & " TP = " & Chr(34) & CodTipReceta & Chr(34)
                   MyBuffer = MyBuffer & "/>"
            ...
            Set RS = vg_db.Execute("sgpadm_Ins_XmlMinutaBloque_V02 '" & MyBuffer & "', '" & vg_codcasino & "', " & vg_codregimen & ", " & vg_codservicio & ", " & Vg_FechaDesde & ", " & Vg_FechaHasta & ", " & FecMinuta & ", " & NumRacTotal & ", '" & IIf(EstGrpEst, "A", "N") & "', '01'")
            If Not RS.EOF Then
...
M_MinBloqueADM2.Caption = M_MinSR1.Caption
Me.Caption = "Minuta bloque AMD " & IIf(vg_IDBloque = 0, "[Modalidad Nuevo]", "[Modalidad Modificación]")
...
'    MaxColumna = DateDiff("d", CDate(fg_Ctod1(Vg_FechaDesde)), CDate(fg_Ctod1(Vg_FechaHasta))) + 1
    ...
    Set RS = vg_db.Execute("SGPADM_Sel_TraerCantidadDiaMinuta '" & Vg_FechaDesde & "', '" & Vg_FechaHasta & "'")
    If Not RS.EOF Then
...
'    Dim AuxTipoMinuta As Boolean
    ...
    Set RS = vg_db.Execute("sgpadm_Sel_TraerTipoCecoMinutaBloque_V01 '" & vg_codcasino & "'")
    If Not RS.EOF Then
...
'       TipoMinuta = False
    ...
    'Ini : Columna Nueva estructura servicio
    ...
    .text = "G. Estructura"
    .ColWidth(1) = 13
    .ColHidden = TipoMinuta 'False
    .TypeHAlign = TypeHAlignLeft
    
    'Fin : Columna Nueva estructura servicio
    '-----------------------------------------
    
    'Ini : Columna estructura servicio
    .Col = 2
    .ColsFrozen = 2
    .VisibleCols = 2
    .ColWidth(2) = 25
    ...
    'Fin : Columna estructura servicio
    
    'Ini : Columna Nueva categoria dietetica
    .Col = 3
    .ColsFrozen = 3
    .VisibleCols = 3
    .Col = 3
    ...
    .ColWidth(3) = 13
    .ColHidden = TipoMinuta 'False
    'Fin : Columna Nueva categoria diatetica
    
    'Ini : Columna Nueva tipo de plato
    .Col = 4
    .ColsFrozen = 4
    .VisibleCols = 4
    .Col = 4
    ...
    .ColWidth(4) = 13
    .ColHidden = TipoMinuta 'False
    'Fin : Columna Nueva tipo de plato
    
    'Ini : Columna Nueva % grupo estructura
    .Col = 5
    .ColsFrozen = 5
    .VisibleCols = 5
    .Col = 5
    ...
    .ColHidden = TipoMinuta 'False
    .TypeHAlign = TypeHAlignLeft
    'Fin : Columna Nueva % grupo estructura
...
'    ReDim Preserve vectorcol(0)
    ...
    For i = 6 To .maxcols Step 7
        ...
        Else
           ...
           'vectorcol(CLng((i / 1) + 0)) = i + 1
            ReDim Preserve vectorcol(CLng((i / 7) + 0))
            vectorcol(CLng((i / 7) + 0)) = i + 1
    ...
    'Ini : agregar columna codigo estructura
    .maxcols = .maxcols + 1
    .Col = .maxcols
    .ColWidth(.maxcols) = 5
    .text = "Còd. Est."
    .ColHidden = True
    'Fin : agregar columna codigo estructura
    
    'Ini : agregar columna codigo grupo estructura
    .maxcols = .maxcols + 1
    .ColID = "Grupo"
    .Col = .maxcols
    .ColWidth(.maxcols) = 5
    .text = "Còd. Grupo."
    .ColHidden = True
    'Fin : agregar columna codigo grupo estructura
   
    'Ini : agregar columna codigo categoria dietetica
    .maxcols = .maxcols + 1
    .ColID = "GrupoDietetica"
    .Col = .maxcols
    .ColWidth(.maxcols) = 5
    .text = "Còd. Cat.Diete."
    .ColHidden = True
    'Fin : agregar columna codigo categoria dietetica
   
    'Ini : agregar columna codigo tipo plato
    .maxcols = .maxcols + 1
    .ColID = "GrupoPlato"
    .Col = .maxcols
    .ColWidth(.maxcols) = 5
    .text = "Còd. T.Plato"
    .ColHidden = True
    'Fin : agregar columna codigo tipo plato
   
    For i = 6 To .maxcols - 4 Step 7
...
With vaSpread1
    ...
    RS.CursorLocation = adUseClient
    vg_db.CursorLocation = adUseClient
    Set RS = vg_db.Execute("sgpadm_Sel_DetalleMinutaBloque_V04 " & vg_IDBloque & ", '" & vg_codcasino & "', " & SeleccionOpt & "")
    ...
    If Not RS.EOF Then
        ...
        Do While Not RS.EOF
           ...
           For i = 6 To (vaSpread1.maxcols - 4) Step 7
               ...
               Call vaSpread1.GetText(i + 1, SpreadHeader + 3, dato)
               If RS!min_fecmin = Val(Format(Mid(dato, 5, Len(dato)), "yyyymmdd")) Then
           ...
           '-------> Buscar grupo estructura servicio
           RowGrupo = vaSpread1.SearchCol(colgrupo, 0, -3, RS!ess_codigo, SearchFlagsValue)
           
           If RowGrupo = -1 Then
              
              
              'descripcion estructura servicio
              .Col = 2
              .CellType = CellTypeStaticText
              .text = RS!ess_nombre
              ...
              'descripción grupo estructura
              .Col = 1
              .CellType = CellTypeStaticText
              .text = RS!nombregestructura
...
'                       .TypeNegRed = True
           ...
           Else
              ...
              If RS!ess_codigo <> CosEst Then
                 ...
                 Else
                    ...
                    vaSpread1.text = Trim(RS!nombregestructura)
           ...
           'descripción categoria diatetica
           .Col = 3
           .CellType = CellTypeStaticText
'           .TypeHAlign = TypeHAlignCenter
           .Value = RS!car_nombre
           
           'descripción tipo de plato
           .Col = 4
           .CellType = CellTypeStaticText
'           .TypeHAlign = TypeHAlignCenter
           .Value = RS!tip_nombre
...
'           .ColHidden = False
          ...
          If Not RS!rec_LYD Then
             ...
             VecCosenc((Int((j + 1) / 7) + 0), 1) = (VecCosenc((Int((j + 1) / 7) + 0), 1) + (RS!promedioreceta * IIf(IsNull(RS!mid_numrac), 0, RS!mid_numrac)))
          
          ElseIf RS!rec_LYD Then
             
             VecCosenc((Int((j + 1) / 7) + 0), 2) = (VecCosenc((Int((j + 1) / 7) + 0), 2) + (RS!promedioreceta * IIf(IsNull(RS!mid_numrac), 0, RS!mid_numrac)))
    ...
    Else
       ...
       RS.CursorLocation = adUseClient
       vg_db.CursorLocation = adUseClient
       Set RS = vg_db.Execute("sgpadm_Sel_PonderacionTotalAgrupacion_V02 '" & vg_codcasino & "'," & vg_codservicio & ", " & vg_codregimen & "")
...
'               .BackColor = Shape1(2).FillColor
    ...
    RS.CursorLocation = adUseClient
    vg_db.CursorLocation = adUseClient
    Set RS = vg_db.Execute("sgpadm_Sel_TraerComensalesMinuta_V01 '" & vg_codcasino & "', " & vg_codregimen & ", " & vg_codservicio & ", " & Val(Vg_FechaDesde) & ", " & Val(Vg_FechaHasta) & ", " & vg_IDBloque & "")
    
    Do While Not RS.EOF
       
       '-------> Buscar día
       For i = 7 To (.maxcols - 4) Step 7
...
'       TipoCopia = "xxx"
       ...
       For j = 1 To vaSpread1.MaxRows - 1
           ...
           If Val(vaSpread1.text) <> CodGrupoEst And Trim(vaSpread1.text) <> "" Then
              vaSpread1.Row = j
              For i = 6 To vaSpread1.maxcols - 4 Step 7

               Call Cal_PorSugerido_RacionesII(j, i + 1)
           ...
           vaSpread1.Row = j
           vaSpread1.Col = vaSpread1.maxcols - 2
           CodGrupoEst = IIf(Trim(vaSpread1.text) = "", -1, Val(vaSpread1.text))
...
'               Call Cal_PorSugerido_Raciones(j, i + 1)
   ...
   If Col <> 1 And Int(Col / 7) <= UBound(VecCosenc) Then
       
       VecCosenc((Int(Col / 7) + 0), 1) = 0
       VecCosenc((Int(Col / 7) + 0), 2) = 0
...
'              vaSpread1.Col = Col + 2: VecCosenc((Int(Col / 7) + 1), 1) = Round(VecCosenc((Int(Col / 7) + 1), 1) + (cosdia * numrac), vg_DCa)
              ...
              If Mid(Trim(vaSpread1.text), 1, 3) <> "[*]" Then
                 ...
                 VecCosenc((Int(Col / 7) + 0), 1) = Round(VecCosenc((Int(Col / 7) + 0), 1) + (cosdia * numrac), vg_DCa)
              
              Else
                 
                 VecCosenc((Int(Col / 7) + 0), 2) = Round(VecCosenc((Int(Col / 7) + 0), 2) + (cosdia * numrac), vg_DCa)
        ...
        vaSpread1.TypeHAlign = TypeHAlignRight
        vCosVec = 0
        vCosVec = Round(VecCosenc((Int(Col / 7) + 0), 1) + VecCosenc((Int(Col / 7) + 0), 2), 2)
        If vTotRac > 0 And vCosVec > 0 Then
...
'                      If (CStr(CodGrupoEst) <> .text Or Trim(NomReceta) = "") And Trim(.text) <> "" Then Exit For
         ...
         ElseIf "% G.Est." = dato Then
            ...
            If RowGrupo > -1 Then
               ...
               For j = 6 To vaSpread1.maxcols - 4 Step 7
...
Sub Cal_PorSugerido_RacionesII(Row As Long, Col As Long)
...
If Not TipoMinuta Then ' Solamente para tipo minuta simap
    ...
    With Me.vaSpread1
         ...
         If "% Pond." = dato Then 'And TipoCopia <> "Copia Raciones" Then
            ...
            If RowGrupo > -1 Then
               ...
               For i = RowGrupo To .MaxRows - 1
                   ...
                   If (CStr(CodGrupoEst) = .text) And Trim(.text) <> "" And Trim(NomReceta) <> "" Then
...
Dim dato    As Variant
    ...
    veccos((Int(Col / 7) + 0), 1) = 0
    veccos((Int(Col / 7) + 0), 2) = 0
    veccos((Int(Col / 7) + 0), 4) = 0
    ...
    For X = 1 To (vaSpread1.MaxRows - 1)
        ...
        If Trim(vaSpread1.text) <> "" And numrac >= 0 Then
           ...
           If Mid(Trim(vaSpread1.text), 1, 3) <> "[*]" Then
              ...
              veccos((Int(Col / 7) + 0), 1) = Round(veccos((Int(Col / 7) + 0), 1) + (cosdia * numrac), vg_DCa)
           
           Else
              
              veccos((Int(Col / 7) + 0), 2) = Round(veccos((Int(Col / 7) + 0), 2) + (cosdia * numrac), vg_DCa)
    ...
    vaSpread1.Row = vaSpread1.MaxRows
    vaSpread1.Col = Col + 1
    veccos((Int(Col / 7) + 0), 4) = Round(veccos((Int(Col / 7) + 0), 4) + IIf(Val(vaSpread1.text) = 0, 0, vaSpread1.text), vg_DCa)
...
'    End If
    ...
    End If
    Label1(20).Caption = Format(veccos((Int(xcol / 7) + 0), 1), fg_Pict(6, 2))
    Label1(21).Caption = Format(veccos((Int(xcol / 7) + 0), 2) + IIf(IsNull(veccos((Int(xcol / 7) + 0), 6)), 0, veccos((Int(xcol / 7) + 0), 6)), fg_Pict(6, 2))
    Label1(22).Caption = Format(CCur(veccos((Int(xcol / 7) + 0), 1) + (veccos((Int(xcol / 7) + 0), 2)) + IIf(IsNull((veccos((Int(xcol / 7) + 0), 6))), 0, (veccos((Int(xcol / 7) + 0), 6)))), fg_Pict(6, 2))
    Label1(23).Caption = Format(veccos((Int(xcol / 7) + 0), 3), fg_Pict(6, 2))
    Label1(44).Caption = Format(veccos((Int(xcol / 7) + 0), 4), fg_Pict(6, 2))
    
    If veccos((Int(xcol / 7) + 0), 4) > 0 Then
       
       Label1(45).Caption = Format(CCur((veccos((Int(xcol / 7) + 0), 1) + (veccos((Int(xcol / 7) + 0), 2)) + IIf(IsNull((veccos((Int(xcol / 7) + 0), 6))), 0, (veccos((Int(xcol / 7) + 0), 6)))) / veccos((Int(xcol / 7) + 0), 4)), fg_Pict(6, 2))
    ...
    Label1(46).Caption = Format(veccos((Int(xcol / 7) + 0), 5), fg_Pict(6, 2))
    
    If veccos((Int(xcol / 7) + 0), 5) > 0 Then
       
       Label1(47).Caption = Format(CCur(veccos((Int(xcol / 7) + 0), 3) / veccos((Int(xcol / 7) + 0), 5)), fg_Pict(6, 2))
...
'        veccos(j, 6) = 0 '-------> Servicio LYD
    ...
    Set RS = vg_db.Execute("sgpadm_Sel_SalidaProduccionMinutaBloque_V01 '" & vg_codcasino & "', " & vg_codregimen & ", " & vg_codservicio & ", " & sql3 & ", 'ctainsumo'")
...
'    End If
    ...
    End If
    Label1(20).Caption = Format(veccos((Int(xcol / 7) + 0), 1), fg_Pict(6, 2))
    Label1(21).Caption = Format((veccos((Int(xcol / 7) + 0), 2)) + (veccos((Int(xcol / 7) + 0), 6)), fg_Pict(6, 2))
    Label1(22).Caption = Format(CCur(veccos((Int(xcol / 7) + 0), 1) + (veccos((Int(xcol / 7) + 0), 2)) + IIf(IsNull(veccos((Int(xcol / 7) + 0), 6)), 0, veccos((Int(xcol / 7) + 0), 6))), fg_Pict(6, 2))
    Label1(23).Caption = Format(veccos((Int(xcol / 7) + 0), 3), fg_Pict(6, 2))
    Label1(44).Caption = Format(nracre, fg_Pict(6, 2))
    If nracre > 0 Then
       
       Label1(45).Caption = Format(CCur((veccos((Int(xcol / 7) + 0), 1) + (veccos((Int(xcol / 7) + 0), 2)) + IIf(IsNull(veccos((Int(xcol / 7) + 0), 6)), 0, veccos((Int(xcol / 7) + 0), 6))) / nracre), fg_Pict(6, 2))
    ...
    If nracfo > 0 Then
       ...
       Label1(47).Caption = Format(CCur(veccos((Int(xcol / 7) + 0), 3) / nracfo), fg_Pict(6, 2))
...
TraerPosicionDia = 0
For i = 5 To (vaSpread1.maxcols - 4) Step 7
...
'-------> Mover columnas
MaxCol = (vaSpread1.maxcols - 4) '- DateDiff("d", CDate(fg_Ctod1(Vg_FechaDesde)), CDate(fg_Ctod1(Vg_FechaHasta))) + 1
...
For j = 1 To vaSpread1.MaxRows
    ...
    For i = 6 To MaxCol Step 7
        ...
        If i = 6 Then
           ...
           vaSpread1.Col = i - 4
           MoverDatosExcel oExcel, oSheet, "A", "A", j + RowSheet, j + RowSheet, IIf(j = vaSpread1.MaxRows, "Comensales", vaSpread1.text)
...
vaSpread1.Row = vaSpread1.ActiveRow
vaSpread1.Col = 5 'vaSpread1.ActiveCol '3
...
For i = 1 To vaSpread1.MaxRows - 1
    ...
    For j = 6 To vaSpread1.maxcols - 4 Step 7
        ...
        If Trim(vaSpread1.text) <> "" Then
           ...
           '------> Mover codigo categoria dietetica
           vaSpread1.Col = vaSpread1.maxcols - 1
           vaSpread1.text = CodCatDie
           
           '------> Mover codigo tipo Plato
           vaSpread1.Col = vaSpread1.maxcols
           vaSpread1.text = codTippla
