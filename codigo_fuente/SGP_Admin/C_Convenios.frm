...
'    xlApp.Visible = True
    ...
    xlWb.Close True, vg_Archxls

    Dim XL As New excel.Application 'Crea el objeto excel
    XL.Workbooks.Open vg_Archxls, , True  'El true es para abrir el archivo en modo Solo lectura (False si lo quieres de otro modo)
    XL.Visible = True
...
Case 1
    Sql = ""
    Sql = "sgpadm_Sel_OrgComprasConvenios "
