...
'    RS.Open "SELECT cli_tipominuta, cli_nombre " & _
'            "FROM b_clientes " & _
...
Private Sub Image1_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 0
            ...
            vg_nombre = "": vg_codigo = ""
            B_TabEst.LlenaDatos "b_clientes", "cli_", "Contratos Envio Minuta Bloque", "Cliente_EnvioBloque"
            B_TabEst.Show 1
            Me.Refresh
...
On Error GoTo Man_Error
    ...
    For i = 1 To vaSpread1.MaxRows
        ...
        If vaSpread1.text = "1" Then
            ...
            Set RS = vg_db.Execute("sgpadm_Sel_ValidarMinutaBloque 1, " & IdMinutaBloque & ", '" & Trim(LimpiaDato(fpText.text)) & "'")
            If RS.EOF Then
    ...
    For i = 1 To vaSpread1.MaxRows
        ...
        If vaSpread1.text = "1" Then
            ...
            Set RS = vg_db.Execute("sgpadm_Sel_ValidarMinutaBloque 2, " & IdMinutaBloque & ", '" & Trim(LimpiaDato(fpText.text)) & "'")
            If RS.EOF Then
    ...
    For i = 1 To vaSpread1.MaxRows
        ...
        If vaSpread1.text = "1" Then
            ...
            Set RS = vg_db.Execute("sgpadm_Upd_EnvioMinutaBloque '" & Trim(LimpiaDato(fpText.text)) & "', " & IdMinutaBloque & "")
            Call fg_descarga
            If Not RS.EOF Then
    ...
    End If
'    Set RS = vg_db.Execute("sgpadm_Upd_EnvioMinutaBloque '" & Trim(LimpiaDato(FpText.text)) & "', '', '', " & id & "")
'    Call fg_descarga
'    If Not RS.EOF Then
'        If UCase(RS(0)) = "OK" Then
'           Call MsgBox("Proceso de Envio Minuta Finalizado", vbInformation + vbOKOnly, Msgtitulo)
'           MoverDatoGrilla
'        Else
'           Call MsgBox("Proceso Finalizado con error " & RS(0), vbInformation + vbOKOnly, Msgtitulo)
'        End If
'    End If
'    RS.Close: Set RS = Nothing
...
Dim Fd As String
Dim Fh As String
Dim TipoMinuta As Long
Dim EstadoMinuta As Long
...
Set RS = vg_db.Execute("sgpadm_Sel_ListarMinutaBloqueEnviar_V02 '" & Trim(LimpiaDato(fpText.text)) & "', " & TipoMinuta & ", " & EstadoMinuta & "")
