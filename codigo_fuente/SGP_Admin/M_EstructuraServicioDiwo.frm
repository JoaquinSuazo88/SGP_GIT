...
Begin VB.Form M_EstructuraServicioDiwo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Parametrizar Estructura Servicio Diwo"
   ClientHeight    =   7350
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   12045
   ...
   Begin VB.Frame Frame2 
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         EndProperty
         MaxCols         =   4
         SpreadDesigner  =   "M_EstructuraServicioDiwo.frx":0000
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image1 
         ...
         Index           =   2
         Left            =   3285
         Picture         =   "M_EstructuraServicioDiwo.frx":18D8
         Top             =   1080
         Width           =   480
      End
      Begin VB.Image Image1 
         ...
         Index           =   1
         Left            =   3285
         Picture         =   "M_EstructuraServicioDiwo.frx":1BE2
         Top             =   660
         Width           =   480
      End
      ...
      Begin VB.Image Image1 
         ...
         Index           =   0
         Left            =   3300
         Picture         =   "M_EstructuraServicioDiwo.frx":1EEC
         Top             =   240
         Width           =   480
      End
      Begin VB.Label fpayuda 
   ...
   End
End
Attribute VB_Name = "M_EstructuraServicioDiwo"
...
vg_codcasino = ""
B_HistorialEstructuraDiwo.LlenarHistorial (LimpiaDato(fpText.text))
B_HistorialEstructuraDiwo.Show 1
...
On Error GoTo Man_Error
    ...
    MsgTitulo = "Parametrizar Estructura Servicio Diwo"
    Call fg_centra(Me)
    Let Me.Height = 7770
    Let Me.Width = 11805
    Frame1.Enabled = True
...
Set RS = vg_db.Execute("sgpadm_Sel_ListarEstServicioxCeco '" & cencos & "', " & Val(fpLongInteger1(0).Value) & ", " & Val(fpLongInteger1(1).Value) & "")
...
Gl_Ac_Botones Me, 1, 18, modo
Set RS = vg_db.Execute("sgpadm_DelIns_XmlHomologacionEstructuraServicioDiwo '" & MyBuffer & "', '" & Ceco & "', " & Regimen & ", " & Servicio & "")
If Not RS.EOF Then
...
Set RS = vg_db.Execute("sgpadm_Del_HomologacionEstructuraServicioDiwo '" & Ceco & "', " & Regimen & ", " & Servicio & "")
If Not RS.EOF Then
   ...
   Else
      ...
      Call MoverGrilla(fpText.text)
      MsgBox "Proceso Eliminación Termino Correctamente ", vbInformation + vbOKOnly, MsgTitulo
