...
Begin VB.Form T_TiempoHHReceta 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Tiempo HH Receta"
   ClientHeight    =   4950
   ClientLeft      =   2940
   ClientTop       =   1110
   ClientWidth     =   8250
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "T_TiempoHHReceta.frx":0000
         Left            =   2010
         List            =   "T_TiempoHHReceta.frx":000A
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      MaxCols         =   6
      ProcessTab      =   -1  'True
      SpreadDesigner  =   "T_TiempoHHReceta.frx":001E
      ScrollBarTrack  =   3
      ClipboardOptions=   0
   End
   ...
   End
End
Attribute VB_Name = "T_TiempoHHReceta"
...
If modo = "A" Then
   ...
   codigo = 0
   Set RS = vg_db.Execute("sgpadm_Ins_TiempoHhReceta '" & Hora & "', '" & vg_NUsr & "'")
   If Not RS.EOF Then
...
Else
   ...
   Set RS = vg_db.Execute("sgpadm_Sel_CodigoTiempoHhReceta " & codigo & "")
   If Not RS.EOF Then
   ...
   Set RS = vg_db.Execute("sgpadm_Upd_TiempoHhReceta " & codigo & ", '" & Hora & "', '" & Activo & "', '" & vg_NUsr & "'")
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
   ...
   Set RS = vg_db.Execute("sgpadm_Sel_BuscarCodigoTiempoHhReceta '%" & UCase(LimpiaDato(fpText1.text)) & "%'")

ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
    
   Set RS = vg_db.Execute("sgpadm_Sel_BuscarNombreTiempoHhReceta '%" & UCase(LimpiaDato(fpText1.text)) & "%'")
...
Case 5
    ...
    Set RS = vg_db.Execute("sgpadm_Del_TiempoHhReceta " & codigo & ", '0', '" & vg_NUsr & "'")
...
Set RS = vg_db.Execute("sgpadm_Sel_TiempoHhReceta")
