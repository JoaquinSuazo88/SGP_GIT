...
Begin VB.Form T_EtiquetadoSelloReceta 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Etiquetado Sello Receta"
   ClientHeight    =   4950
   ClientLeft      =   2940
   ClientTop       =   1110
   ClientWidth     =   7230
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "T_EtiquetadoSelloReceta.frx":0000
         Left            =   2010
         List            =   "T_EtiquetadoSelloReceta.frx":000A
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      MaxCols         =   6
      ProcessTab      =   -1  'True
      SpreadDesigner  =   "T_EtiquetadoSelloReceta.frx":001E
      ScrollBarTrack  =   3
      ClipboardOptions=   0
   End
End
Attribute VB_Name = "T_EtiquetadoSelloReceta"
...
If modo = "A" Then
   ...
   codigo = 0
   Set RS = vg_db.Execute("sgpadm_Ins_EtiquetadoSelloReceta '" & Trim(Nombre) & "', '" & vg_NUsr & "'")
   If Not RS.EOF Then
...
Else
   ...
   Set RS = vg_db.Execute("sgpadm_Sel_CodigoEtiquetadoSelloReceta " & codigo & "")
   If Not RS.EOF Then
       
      MensajeAnterior = codigo & ";" & IIf(IsNull(RS!NombreEtiquetadoSello), "", Trim(RS!NombreEtiquetadoSello)) & ";" & IIf(IsNull(RS!Activo), "", Trim(RS!Activo)) & ";" & vg_NUsr
   ...
   Set RS = vg_db.Execute("sgpadm_Upd_EtiquetadoSelloReceta " & codigo & ", '" & Trim(Nombre) & "', '" & Activo & "', '" & vg_NUsr & "'")
...
Me.Height = 5385
Me.Width = 11820
MsgTitulo = "Etiquetado Sello Receta"
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
   ...
   Set RS = vg_db.Execute("sgpadm_Sel_BuscarCodigoEtiquetadoSelloReceta '%" & UCase(LimpiaDato(fpText1.text)) & "%'")

ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
    
   Set RS = vg_db.Execute("sgpadm_Sel_BuscarNombreEtiquetadoSelloReceta '%" & UCase(LimpiaDato(fpText1.text)) & "%'")
...
If Not RS.EOF Then
   ...
   Do While Not RS.EOF
      ...
      vaSpread1.Value = RS!IdEtiquetadoSello
      
      vaSpread1.Col = 2
      vaSpread1.Value = IIf(IsNull(RS!NombreEtiquetadoSello), "", Trim(RS!NombreEtiquetadoSello))
...
Case 5
    ...
    Set RS = vg_db.Execute("sgpadm_Del_EtiquetadoSelloReceta " & codigo & ", '0', '" & vg_NUsr & "'")
...
Set RS = vg_db.Execute("sgpadm_Sel_EtiquetadoSelloReceta")
