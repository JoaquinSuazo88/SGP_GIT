...
Set RS = vg_db.Execute("sgpadm_Sel_ComposicionMinuta_V04 '" & LimpiaDato(fpText1.text) & "', " & IIf(Trim(regimen) = "", 0, regimen) & ", " & Format(FpFecDesde.text, "yyyymmdd") & ", " & Format(FpFecHasta.text, "yyyymmdd") & " ")
