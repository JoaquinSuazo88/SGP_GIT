...
Begin VB.Form M_IncIngExceso 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ingredientes Incluidos Saldo Abastecimiento en Exceso"
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   12810
   ...
   Begin VB.Frame Frame2 
      Caption         =   "Ingrediente No Incluido Exceso"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Begin FPSpread.vaSpread vaSpread2 
         ...
         MaxRows         =   2
         ScrollBars      =   2
         SpreadDesigner  =   "M_IncIngExceso.frx":0000
      End
      Begin EditLib.fpText text2 
         Height          =   315
         Index           =   3
   ...
   Begin VB.Frame Frame1 
      Caption         =   "Ingrediente Incluido Exceso"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         MaxRows         =   2
         ScrollBars      =   2
         SpreadDesigner  =   "M_IncIngExceso.frx":03EB
      End
      Begin EditLib.fpText TEXT1 
         Height          =   315
         Index           =   2
   ...
   End
End
Attribute VB_Name = "M_IncIngExceso"
...
On Error GoTo Man_Error
  ...
  Call carga_ingredientes
  Call carga_ingredientes_con_exceso
...
Private Sub carga_ingredientes_con_exceso()

 On Error GoTo Man_Error
    Sql = " sgpadm_Sel_Ingredientes_Exceso "
...
Private Sub carga_ingredientes()

 On Error GoTo Man_Error
 
    Sql = " sgpadm_Sel_Ingrediente_Sin_Exceso "
    Set RS = vg_db.Execute(Sql)
   ...
   '-------> Inicio LLenar grilla
    ...
    Do While Not RS.EOF
        ...
        vaSpread1.Col = 2 ' Codigo Ingrediente
...
Private Sub genera_ingredientes()
...
' Rescata la Familia de Producto Seleccionada
   ...
   xmlfamilia = xmlfamilia & "<Ingredientes>"
  
  For i = 1 To vaSpread2.MaxRows
    
    xmlfamilia = xmlfamilia & " <Ingrediente"
    vaSpread2.Row = i
    vaSpread2.Col = 2 'Id Ruta de Compras
    Ingrediente = IIf(vaSpread2.text = "", 0, vaSpread2.text)
    xmlfamilia = xmlfamilia & " Ing = " & Chr(34) & Ingrediente & Chr(34)
  ...
  Next i
    ...
    Sql = " sgpadm_Ins_Ingredientes_Con_Exceso "
    Sql = Sql & " '" & xmlfamilia & "'"
    Set RS = vg_db.Execute(Sql)
  ...
  MsgBox "La Generacion de Ingredientes Termino Correctamente", vbExclamation
...
On Error GoTo Man_Error
    ...
    Case 1 ' Genera los ingredientes con exceso
       Call genera_ingredientes
