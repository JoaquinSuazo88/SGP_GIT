...
Begin VB.Form M_DocAux 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.Frame Frame10 
         ...
         Begin FPSpread.vaSpread vaSpread2 
            ...
            ProcessTab      =   -1  'True
            ScrollBars      =   2
            SpreadDesigner  =   "M_DocAux.frx":0000
         End
      End
      Begin FPSpread.vaSpread vaSpread1 
         ...
         SpreadDesigner  =   "M_DocAux.frx":0598
         VisibleCols     =   11
         TextTip         =   2
         TextTipDelay    =   0
         ScrollBarTrack  =   3
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_DocAux.frx":166A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "M_DocAux.frx":1984
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Combo2 
         ...
         Height          =   315
         Index           =   0
         ItemData        =   "M_DocAux.frx":1C9E
         Left            =   7995
         List            =   "M_DocAux.frx":1CA0
      ...
      Begin VB.ComboBox Combo2 
         ...
         Height          =   315
         Index           =   1
         ItemData        =   "M_DocAux.frx":1CA2
         Left            =   1860
         List            =   "M_DocAux.frx":1CA4
         Style           =   2  'Dropdown List
         TabIndex        =   6
         TabStop         =   0   'False
         Top             =   1320
...
Double1(12).Enabled = True: Double1(13).Enabled = True: Double1(14).Enabled = True: Double1(15).Enabled = True: Double1(17).Enabled = True
Double1(5).text = "": Double1(6).text = ""
Double1(12).text = "": Double1(13).text = "": Double1(14).text = "": Double1(15).text = "": Double1(16).text = "": Double1(17).text = ""
Date1(0).text = "": Date1(1).text = "": Text1(0).text = ""
...
If Not RS1.EOF Then indice = RS1!mayor
...
Do While Not RS1.EOF
    ...
    Impuestos(indice, 3) = IIf(IsNull(RS1!imp_pctimp), 0, RS1!imp_pctimp)
    Impuestos(indice, 4) = 0
    Impuestos(indice, 5) = RS1!imp_inccos
    If vaSpread2.SearchCol(1, 0, vaSpread2.MaxRows, CStr(RS1!imp_codigo), SearchFlagsNone) = -1 Then
       vaSpread2.MaxRows = vaSpread2.MaxRows + 1
       vaSpread2.Row = vaSpread2.MaxRows
       vaSpread2.Col = 1: vaSpread2.text = CStr(RS1!imp_codigo): vaSpread2.Lock = True
       vaSpread2.Col = 2: vaSpread2.text = "1": vaSpread2.Lock = False
       vaSpread2.Col = 3: vaSpread2.text = Trim(RS1!imp_nombre): vaSpread2.Lock = True
       vaSpread2.Col = 4: vaSpread2.text = IIf(IsNull(RS1!imp_pctimp), Format(0, fg_Pict(3, 2)), Format(RS1!imp_pctimp, fg_Pict(3, 2))) & " %": vaSpread2.Lock = True
       vaSpread2.Col = 5: vaSpread2.text = Format(0, fg_Pict(6, 0)): vaSpread2.ForeColor = IIf(RS1!imp_indmod = "S", &HC00000, &H80000008): vaSpread2.Lock = IIf(RS1!imp_indmod = "S", False, True)
       vaSpread2.Col = 6: vaSpread2.text = RS1!imp_inccos: vaSpread2.Lock = True
       vaSpread2.Col = 7: vaSpread2.text = IIf(IsNull(RS1!imp_pctimp), 0, RS1!imp_pctimp): vaSpread2.Lock = True
       vaSpread2.Col = 8: vaSpread2.text = IIf(RS1!imp_indmod = "S", 1, 0): vaSpread2.Lock = True
...
'    vaSpread2.Col = 5: vaSpread2.Text = ""
'    vaSpread2.Col = 6: vaSpread2.Lock = True
'    vaSpread2.Col = 7: vaSpread2.Lock = True
'    vaSpread2.Col = 8: vaSpread2.Lock = True
'    If vaSpread2.Text = "1" Then vaSpread2.Col = 4: vaSpread2.Text = Format(0, fg_Pict(3, 2)) & " %": vaSpread2.Col = 5: vaSpread2.Text = 0: vaSpread2.Lock = False
'    vaSpread2.RowHidden = True
'Next i
...
For i = 1 To UBound(Impuestos)
    Impuestos(i, 4) = 0
Next i
TotE = 0: TotN = 0: TotI = 0: TotO = 0: Cant = 0: PreC = 0: MonD = 0: MonI = 0: Cdif = 0
StrImp = "": StrImpb = ""
...
For i = 1 To UBound(Impuestos)
    ...
    End If
Next i
vTotExe = 0: vTotNet = 0: vTotIva = 0: vTotOtr = 0: vTotTot = 0
...
Else
    ...
    vTotIva = 0
    vTotOtr = 0
    vTotTot = Format(TotN, fg_Pict(9, 0))
End If
...
On Error GoTo Error_Suma
TotE = 0: TotN = 0: TotI = 0: TotO = 0: PctI = 0: CosI = 0: Cant = 0: DifUni = 0: MonTot = 0
PreC = 0: MonD = 0: monpro = 0: MonI = 0
StrImp = "": StrImpb = ""
For i = 1 To UBound(Impuestos)
    Impuestos(i, 4) = 0
Next i
    ...
    If codpro <> "" Or IsNull(codpro) = False Then
        ...
        If Len(StrImp) <> 0 Then
            Do While InStr(StrImp, ";") <> 0
                ...
                Else
                   If codi = 11 And (fg_codigocbo(Combo2, 0, 2, "") = "FA" Or fg_codigocbo(Combo2, 0, 2, "") = "FE" Or fg_codigocbo(Combo2, 0, 2, "") = "NC" Or fg_codigocbo(Combo2, 0, 2, "") = "CE" Or fg_codigocbo(Combo2, 0, 2, "") = "ND" Or fg_codigocbo(Combo2, 0, 2, "") = "DE") Then
                      TotE = TotE + monpro
                   ElseIf codi = 11 And fg_codigocbo(Combo2, 0, 2, "") = "GD" Then
                      TotN = TotN + Format(monpro, fg_Pict(9, 0))
                   End If
                   If PctI > 0 Then
                      TotO = TotO + IIf(fg_codigocbo(Combo2, 0, 2, "") = "BH", Round(((monpro / ((100 - PctI) / 100))) / PctI), Round(monpro * (PctI / 100), 2))
                   Else
                      TotO = TotO + 0
                   End If
                End If
...
Next i
vTotExe = 0: vTotNet = 0: vTotIva = 0: vTotOtr = 0: vTotTot = 0
If fg_codigocbo(Combo2, 0, 2, "") <> "GD" And fg_codigocbo(Combo2, 0, 2, "") <> "BO" And fg_codigocbo(Combo2, 0, 2, "") <> "CG" Then
   ...
   vTotTot = Format(TotE + TotN + IIf(fg_codigocbo(Combo2, 0, 2, "") = "BH", 0, Round(TotI, 0)) + Round(TotO, 0) + IIf(Double1(17).Value > 0, Double1(17).Value, 0), fg_Pict(9, 0))
Else
   vTotExe = 0
   vTotNet = Round(IIf(Trim(fg_codigocbo(Combo2, 0, 2, "")) = "GD", TotN, 0), 0)
   vTotIva = 0
   vTotOtr = 0
   vTotTot = Format(TotN, fg_Pict(9, 0))
End If
...
If Trim(fg_codigocbo(Combo2, 0, 2, "")) = "FA" Or Trim(fg_codigocbo(Combo2, 0, 2, "")) = "FE" Then
    vg_FDC = "GD"
    RS1.Open "SELECT COUNT(toc_numdoc) AS nreg FROM b_totcompras WHERE toc_rutpro='" & fg_DespintaRut(fpText(0).text) & "' AND (toc_docaso = '' OR toc_docaso IS NULL) AND toc_tipdoc='" & vg_FDC & "' AND toc_codbod=" & vg_codbod & "", vg_db, adOpenStatic
    Image1(1).Visible = IIf(RS1.EOF Or RS1!nreg = 0 Or IsNull(RS1!nreg), False, True)
    RS1.Close: Set RS1 = Nothing
    ChequearOCompras
ElseIf Trim(fg_codigocbo(Combo2, 0, 2, "")) = "NC" Or Trim(fg_codigocbo(Combo2, 0, 2, "")) = "CE" Then
   vg_FDC = "SN"
   If vg_tipbase = "1" Then
      RS1.Open "SELECT COUNT(toc_numdoc) AS nreg FROM b_totcompras WHERE trim(toc_docaso) IN (SELECT trim(toc_numdoc) FROM b_totcompras WHERE (toc_tipdoc = 'FA' OR toc_tipdoc = 'FE') AND (toc_docsnc = '' OR toc_docaso IS NULL)) AND  toc_rutpro = '" & fg_DespintaRut(fpText(0).text) & "' AND toc_tipdoc = '" & Trim(vg_FDC) & "' AND (toc_docsnc = '' OR (toc_docsnc) IS NULL) AND toc_codbod=" & vg_codbod & "", vg_db, adOpenStatic
   Else
      RS1.Open "SELECT COUNT(toc_numdoc) AS nreg FROM b_totcompras WHERE ltrim(toc_docaso) IN (SELECT ltrim(toc_numdoc) FROM b_totcompras WHERE (toc_tipdoc = 'FA' OR toc_tipdoc = 'FE') AND (ltrim(toc_docsnc) = '' OR toc_docaso IS NULL)) AND  toc_rutpro = '" & fg_DespintaRut(fpText(0).text) & "' AND toc_tipdoc = '" & Trim(vg_FDC) & "' AND (ltrim(toc_docsnc) = '' OR (toc_docsnc) IS NULL) AND toc_codbod = " & vg_codbod & "", vg_db, adOpenStatic
   End If
   Image1(1).Visible = IIf(RS1.EOF Or RS1!nreg = 0 Or IsNull(RS1!nreg), False, True)
   RS1.Close: Set RS1 = Nothing
End If
Select Case fg_codigocbo(Combo2, 0, 2, "") 'Combo2(0).ListIndex
...
Case Is = "GD" '-------> GUIA DE DEPACHO(GD)
    Double1(12).Enabled = False: Double1(13).Enabled = True: Double1(14).Enabled = False: Double1(15).Enabled = False: Double1(17).Enabled = False
    Double1(12).text = "": Double1(14).text = "": Double1(15).text = "": Double1(17).text = ""
    Combo2(1).Enabled = False: fpText(1).Enabled = True
Case Is = "BH" '-------> BOLETA DE HONORARIOS(BH)
    Combo2(1).Enabled = False: fpText(1).Enabled = True
Case Is = "BO", "CG" ' Boleta(BO), Comprobante de Gasto(CG)
    Combo2(1).Enabled = False: fpText(1).Enabled = False
    Double1(12).Enabled = False: Double1(13).Enabled = False: Double1(14).Enabled = False: Double1(15).Enabled = False: Double1(17).Enabled = False
    Double1(12).text = "": Double1(13).text = "": Double1(14).text = "": Double1(15).text = "": Double1(17).text = ""
End Select
'If Combo2(0).ListIndex = 0 Or Combo2(0).ListIndex = 4 Or Combo2(0).ListIndex = 5 Then
'    Option1(0).Enabled = True
'    Option1(1).Enabled = True
'    Option1(1).Value = True
'ElseIf Combo2(0).ListIndex = 1 Or Combo2(0).ListIndex = 2 Or Combo2(0).ListIndex = 3 Then
'    Option1(0).Enabled = False
'    Option1(0).Value = False
'    Option1(1).Enabled = True
'    Option1(1).Value = True
'ElseIf Combo2(0).ListIndex = 6 Then
'    Option1(0).Enabled = True
'    Option1(0).Value = True
'    Option1(1).Enabled = False
'    Option1(1).Value = False
'End If
Select Case fg_codigocbo(Combo2, 0, 2, "")
Case Is = "FA", "FE", "BO", "BH"
    Option1(0).Enabled = True
    Option1(1).Enabled = True
    Option1(1).Value = True
...
'             "FROM b_ocsac a, b_ocsac b " & _
'             "WHERE a.cadfor_nrcgc = b.cadfor_nrcgc " & _
'             "AND   a.solite_dtent = b.solite_dtent " & _
'             "AND   a.cadfil_cdfil = b.cadfil_cdfil " & _
'             "AND   a.cpopro_cdpro = b.cpopro_cdpro " & _
'             "AND   b.tipsol_idsol = 4 " & _
'             "AND   a.cadfor_nrcgc = '" & fg_DespintaRut(fpText(0).text) & "' " & _
...
If Not RS5.EOF And Not IsNull(RS5!difer) Then
   ...
   RS6.Open "SELECT " & sql3 & " " & _
            ...
            "AND    a.cadfil_cdfil = '" & MuestraCasino(1) & "' " & _
            "AND    " & sql1 & "   = " & sql2 & " " & _
            "AND    a.cadfor_nrcgc = '" & fg_DespintaRut(fpText(0).text) & "' AND a.cpopro_cdpro = b.ocr_codprodsac", vg_db, adOpenStatic
   Image1(4).Visible = IIf(RS6.EOF Or RS6!difer <> 0 Or IsNull(RS6!difer) Or RS5!difer > 0, True, False)
...
If Not IsDate(Date1(0).text) Or Not IsDate(Date1(1).text) Then Exit Sub
...
If Index = 13 And Trim(fg_codigocbo(Combo2, 0, 2, "")) = "GD" Then Double1(16).Value = Double1(13).Value
If Index = 16 And Trim(fg_codigocbo(Combo2, 0, 2, "")) = "GD" Then Double1(13).Value = Double1(16).Value
End Sub
...
RS1.Open "SELECT * FROM  b_totcompras WHERE toc_rutpro = '" & fg_DespintaRut(fpText(0).text) & "' " & _
         "AND toc_codbod = " & vg_codbod & " AND toc_tipdoc = '" & fg_codigocbo(Combo2, 0, 2, "") & "' " & _
         "AND toc_numdoc = " & Val(Double1(5).Value), vg_db, adOpenStatic
If RS1.EOF Then '-------> Si no existe el documento
'    If modo = "" Or modo = "N" Then modo = "A"
...
Else
    ...
    Double1(12).text = RS1!toc_exedoc
    Double1(13).text = RS1!toc_netdoc
    Double1(14).text = RS1!toc_ivadoc
    Double1(15).text = RS1!toc_otrimp
    Double1(16).text = RS1!toc_totdoc
    Double1(17).text = RS1!toc_fledoc
    ...
    RS2.Open "SELECT DISTINCT ocr_rutpro FROM b_ocsacrecibido WHERE ocr_rutpro = '" & fg_DespintaRut(fpText(0).text) & "' AND ocr_tipdoc = '" & fg_codigocbo(Combo2, 0, 2, "") & "' AND ocr_numdoc = " & Val(Double1(5).Value) & "", vg_db, adOpenStatic
    If Not RS2.EOF Then
       ...
       tipord = "OC"
       RS2.Open "SELECT distinct a.*, b.*, c.uni_nomcor, d.*, e.foc_nomsac FROM b_detcompras a, b_productos b, a_unidad c, b_ocsacrecibido d, b_formatocompras e WHERE a.dec_rutpro = d.ocr_rutpro AND d.ocr_tipdoc = a.dec_tipdoc AND a.dec_numdoc = d.ocr_numdoc AND a.dec_codmer = d.ocr_codprodsgp AND d.ocr_codprodsac = e.foc_codsac AND a.dec_codmer = b.pro_codigo AND b.pro_coduni = c.uni_codigo AND a.dec_rutpro = '" & fg_DespintaRut(fpText(0).text) & "' AND a.dec_tipdoc = '" & fg_codigocbo(Combo2, 0, 2, "") & "' AND a.dec_numdoc = " & Val(Double1(5).Value) & " ORDER BY a.dec_numlin", vg_db, adOpenStatic
    Else
       RS2.Close: Set RS2 = Nothing
       vaSpread1.Col = 10: vaSpread1.ColHidden = False
       vaSpread1.Col = 20: vaSpread1.ColHidden = True
    ...
    With vaSpread1
         ...
         Do While Not RS2.EOF
            ...
            '20080417
            Text1(0).text = RS2!dec_descri
            .Col = 13: .Value = RS2!dec_mueinv
            If tipord = "OC" Then
               .Col = 21: .Value = Format(RS2!ocr_canoc, fg_Pict(9, 2))
               .Col = 22: .Value = Format(RS2!ocr_preoc, fg_Pict(9, 2))
               .Col = 23: .Value = IIf(IsNull(RS2!ocr_fecoc), "", RS2!ocr_fecoc)
               .Col = 24: .Value = IIf(IsNull(RS2!ocr_codprodsac), "", RS2!ocr_codprodsac)
               .Col = 25: .Value = IIf(IsNull(RS2!foc_nomsac), "", Trim(RS2!foc_nomsac))
               If .MaxRows = 1 Then
                  Text2(0).text = IIf(IsNull(RS2!ocr_codprodsac), "", Trim(RS2!ocr_codprodsac))
                  Text2(1).text = IIf(IsNull(RS2!foc_nomsac), "", Trim(RS2!foc_nomsac))
               End If
            End If
            RS2.MoveNext
         Loop
    ...
    codpro = ""
    est1 = True
    RS2.Open "SELECT a.*, b.imp_inccos FROM b_detcomprasimp a, a_impuesto b WHERE a.imd_codimp = b.imp_codigo AND a.imd_rutdoc = '" & fg_DespintaRut(fpText(0).text) & "' AND a.imd_tipdoc = '" & fg_codigocbo(Combo2, 0, 2, "") & "' AND a.imd_numdoc = " & Val(Double1(5).Value) & " ORDER BY a.imd_codpro, a.imd_numlin", vg_db, adOpenStatic
    If Not RS2.EOF Then
        Do While Not RS2.EOF
           If vaSpread1.SearchCol(1, 0, vaSpread1.MaxRows, RS2!imd_codpro, SearchFlagsNone) <> -1 Then
              vaSpread1.Row = vaSpread1.SearchCol(1, 0, vaSpread1.MaxRows, RS2!imd_codpro, SearchFlagsNone)
              If RS2!imd_codpro <> codpro Then
                 vaSpread1.Col = 14: vaSpread1.text = ""
                 codpro = RS2!imd_codpro
              End If
              vaSpread1.Col = 14: vaSpread1.text = vaSpread1.text & Trim(Str(RS2!imd_codimp)) & "&"
              vaSpread1.Col = 14: vaSpread1.text = vaSpread1.text & Trim(Str(RS2!imd_pctimp)) & "&"
              vaSpread1.Col = 14: vaSpread1.text = vaSpread1.text & Trim(Str(RS2!imp_inccos)) & ";"
           End If
           RS2.MoveNext
        Loop
    End If
...
est = False: est1 = False: est2 = False
StopObjeto True
fg_centra Me
vaSpread1.Row = -1
...
Double1(12).DecimalPoint = vg_CDec: Double1(12).Separator = vg_CSep: Double1(12).DecimalPlaces = vg_DPr
Double1(13).DecimalPoint = vg_CDec: Double1(13).Separator = vg_CSep: Double1(13).DecimalPlaces = vg_DPr
Double1(14).DecimalPoint = vg_CDec: Double1(14).Separator = vg_CSep: Double1(14).DecimalPlaces = vg_DPr
Double1(15).DecimalPoint = vg_CDec: Double1(15).Separator = vg_CSep: Double1(15).DecimalPlaces = vg_DPr
Double1(16).DecimalPoint = vg_CDec: Double1(16).Separator = vg_CSep: Double1(16).DecimalPlaces = vg_DPr
Double1(17).DecimalPoint = vg_CDec: Double1(17).Separator = vg_CSep: Double1(17).DecimalPlaces = vg_DPr

Combo2(0).Clear
RS1.Open "SELECT * FROM a_tipodocumento ORDER BY tdo_orden", vg_db, adOpenStatic
If Not RS1.EOF Then
   Do While Not RS1.EOF
      Combo2(0).AddItem Trim(RS1!tdo_nombre) & Space(150) & "(" & Trim(RS1!tdo_codigo) & ")"
      RS1.MoveNext
   Loop
End If
RS1.Close: Set RS1 = Nothing
'Combo2(0).AddItem "FACTURA" & Space(150) & "(FA)"
'Combo2(0).AddItem "GUIA DE DESPACHO" & Space(150) & "(GD)"
...
'Combo2(0).AddItem "COMPROBANTE DE GASTO" & Space(150) & "(CG)"
Combo2(0).ListIndex = -1
Combo2(1).Clear

RS1.Open "SELECT a.* FROM a_bodega a, b_clientes b WHERE a.bod_codigo = b.cli_codbod AND b.cli_codigo = '" & vg_contra & "' ORDER BY bod_nombre", vg_db, adOpenStatic
Do While Not RS1.EOF
...
Case 2
    RS1.Open "SELECT * FROM b_clientes WHERE cli_codigo='" & fpText(2).text & "' AND cli_tipo=0", vg_db, adOpenStatic
    If RS1.EOF Then RS1.Close: Set RS = Nothing: fpayuda(0).Caption = "": Exit Sub
...
Case 0
    ...
    If Not RS4.EOF Then
        ...
        ElseIf Trim(fg_codigocbo(Combo2, 0, 2, "")) = "NC" Or Trim(fg_codigocbo(Combo2, 0, 2, "")) = "CE" Then
           vg_FDC = "SN"
           RS1.Open "SELECT COUNT(toc_numdoc) AS nreg FROM b_totcompras WHERE trim(toc_docaso) IN (SELECT trim(toc_numdoc) FROM b_totcompras WHERE (toc_tipdoc = 'FA' OR toc_tipdoc = 'FE') AND (toc_docsnc = '' OR toc_docsnc IS NULL) AND toc_codbod = " & vg_codbod & ") AND  toc_rutpro = '" & fg_DespintaRut(fpText(0).text) & "' AND toc_tipdoc='" & Trim(vg_FDC) & "' AND (toc_docsnc = '' OR (toc_docsnc) IS NULL) AND toc_codbod = " & vg_codbod & "", vg_db, adOpenStatic
           Image1(1).Visible = IIf(RS1.EOF Or RS1!nreg = 0 Or IsNull(RS1!nreg), False, True)
           RS1.Close: Set RS1 = Nothing
        End If
    Else
       RS4.Close: Set RS4 = Nothing: MsgBox "Proveedor no existe...", vbCritical, Msgtitulo
       fpText(0).text = "": fpayuda(0).Caption = ""
       Exit Sub
    End If
...
Case 1
    ...
    If Trim(vg_Guias) <> "" Then
       ...
       Double1(12).Enabled = False: Double1(13).Enabled = False: Double1(14).Enabled = False: Double1(15).Enabled = False: Double1(16).Enabled = False
       Text2(0).Visible = False: Text2(1).Visible = False
       vaSpread1.Col = 10: vaSpread1.ColHidden = False
       vaSpread1.Col = 20: vaSpread1.ColHidden = True
       vaSpread1.Col = 21: vaSpread1.ColHidden = True
...
Case 4
    If Trim(fg_codigocbo(Combo2, 0, 2, "")) = "FA" Or Trim(fg_codigocbo(Combo2, 0, 2, "")) = "FE" Then
        vg_FDC = "OC"
        B_Guias.Cargar_DoctoGrilla "OC", "Ordenes de Compras", fg_DespintaRut(fpText(0).text)
    End If
    vg_RDC = fg_DespintaRut(fpText(0).text)
    B_Guias.Show 1
    If Trim(vg_Guias) <> "" Then
       ...
       Double1(16).text = vTotTot
       Text1(0).Enabled = False
       Double1(12).Enabled = True: Double1(13).Enabled = True: Double1(14).Enabled = True: Double1(15).Enabled = True: Double1(16).Enabled = True
       Frame6.Enabled = True
       Toolbar2.Enabled = True
       Text2(0).Visible = True: Text2(1).Visible = True
       vaSpread1.ColWidth(2) = 42.13 '41.13
       vaSpread1.ColWidth(4) = 9 '8
       vaSpread1.ColWidth(5) = 8.75 '7.75
       vaSpread1.ColWidth(8) = 10.13 '9.13
...
If Encontrado = False Then
    RS1.Open "SELECT * FROM a_infcfcfofi WHERE inf_cencos='" & Trim(fpText(2).text) & "' AND inf_tipo='" & IIf(Option1(0).Value = True, "F", "C") & "' AND inf_feccie=0", vg_db, adOpenStatic
    If Not RS1.EOF Then
       '-------> Validar cantidad documento en un folio
       Double1(6).Value = RS1!inf_numero
'       RS2.Open "SELECT COUNT(*) AS nreg FROM b_totcompras a, a_tipodocumento b WHERE a.toc_tipdoc=b.tdo_codigo AND NOT ISNULL(b.tdo_cladoc) AND b.tdo_cladoc<>'' AND a.toc_numinf=" & RS1!inf_numero & " AND a.toc_tipinf='" & IIf(Option1(0).Value = True, "F", "C") & "' AND a.toc_codbod=" & vg_codbod & "", vg_db, adOpenStatic
'       If Not RS2.EOF Then If RS2!nreg > 20 Then MsgBox "Folio excede los 20 documento, genero un nuevo folio...", vbExclamation + vbOKOnly, Msgtitulo
'       RS2.Close: Set RS2 = Nothing
    Else
        RS2.Open "SELECT MAX(inf_numero) AS Mayor FROM a_infcfcfofi WHERE inf_cencos='" & Trim(fpText(2).text) & "' AND inf_tipo='" & IIf(Option1(0).Value = True, "F", "C") & "'", vg_db, adOpenStatic
        Double1(6).Value = TipoDato(RS2!mayor, 0) + 1
        RS2.Close: Set RS2 = Nothing
        vg_db.BeginTrans
        vg_db.Execute "INSERT INTO a_infcfcfofi VALUES ('" & Trim(fpText(2).text) & "', '" & IIf(Option1(0).Value = True, "F", "C") & "', " & Val(Double1(6).Value) & ", 0, '')"
        vg_db.CommitTrans
    End If
    IndiceOpt = Index
    RS1.Close: Set RS1 = Nothing
...
Dim StoA As Double, PPPA As Double, PreC As Double, Cdif As Long, v_casino As String, vTotRec As Double, vPreDec As Double, periodo As Long, activo As String
...
Case 8 '-------> Grabar
    ...
    ingcfc = True
'    ingcfc = False
'    RS1.Open "SELECT ada_fecumo FROM b_actuadatos WHERE ada_nomtab='b_proveedor' AND (ada_fecumo) IS NOT NULL", vg_db, adOpenStatic
'    If Not RS1.EOF Then ingcfc = True
'    RS1.Close: Set RS1 = Nothing
    '-------> Validar si proveedor es local
    RS1.Open "SELECT prv_origen FROM b_proveedor WHERE prv_codigo='" & v_rut & "'", vg_db, adOpenStatic
    ...
    RS1.Close: Set RS1 = Nothing
    If CierrePeriodo(Format(Date1(0).text, "yyyymmdd"), v_bodega, 0) And Len(Trim(vg_Guias)) < 1 Then MsgBox "Documento no corresponde al periodo : " & VgLinea & VgLinea & CierreFecha, vbExclamation + vbOKOnly, Msgtitulo: Exit Sub
    If CierrePeriodo(Format(Date1(0).text, "yyyymmdd"), v_bodega, 6) And Format(CDate(vg_ciedia), "mm/yyyy") = Format(CDate(Date1(0).Value), "mm/yyyy") Then MsgBox "No puede ingresar documentos anteriores a la última toma de inventario...", vbExclamation + vbOKOnly, Msgtitulo: Exit Sub
    If CierrePeriodo(Format(Date1(0).text, "yyyymmdd"), v_bodega, 12) Then MsgBox "La fecha del documento es mayor a la fecha del periodo : " & VgLinea & VgLinea & CierreFecha, vbExclamation + vbOKOnly, Msgtitulo: Exit Sub
    If CierrePeriodo(Format(Date1(0).text, "yyyymmdd"), v_bodega, 8) Then MsgBox "No ha realizado el ajuste correspondiente a la última toma de inventario...", vbExclamation + vbOKOnly, Msgtitulo: Exit Sub
    If CDate(Date1(0).Value) < CDate(vg_ciedia) And Format(CDate(vg_ciedia), "mm/yyyy") = Format(CDate(Date1(0).Value), "mm/yyyy") Then MsgBox "Día se encuentra cerrado, no es posible ingresar...", vbExclamation + vbOKOnly, Msgtitulo: Exit Sub
...
'20080311    If Not RS1.EOF Then If RS1!fecemi <> Format(Date1(0).text, "mm/yyyy") Then MsgBox "Nº folio corresponde al periodo : " & RS1!fecemi & " " & VgLinea & VgLinea & "Tiene que generar un nuevo folio", vbExclamation + vbOKOnly, Msgtitulo: RS1.Close: Set RS1 = Nothing: Exit Sub
'20080311    RS1.Close: Set RS1 = Nothing
    If vg_tipbase = "1" Then
       RS1.Open "SELECT DISTINCT toc_numinf, FORMAT(toc_fecemi, 'mm/yyyy') AS fecemi FROM b_totcompras WHERE toc_numinf = " & Val(Double1(6).text) & " AND  toc_tipinf = '" & IIf(Option1(0).Value = True, "F", "C") & "' AND toc_codbod = " & vg_codbod & "", vg_db, adOpenStatic
    Else
       RS1.Open "SELECT DISTINCT toc_numinf, CASE WHEN convert(varchar(2),datepart(mm,toc_fecemi)) < 10 THEN '0' + convert(varchar(2),datepart(mm,toc_fecemi)) ELSE convert(varchar(2),datepart(mm,toc_fecemi)) END + '/' + convert(varchar(4),datepart(year, toc_fecemi)) AS fecemi FROM b_totcompras WHERE toc_numinf = " & Val(Double1(6).text) & " AND  toc_tipinf = '" & IIf(Option1(0).Value = True, "F", "C") & "' AND toc_codbod = " & vg_codbod & "", vg_db, adOpenStatic
    End If
    If Not RS1.EOF Then If RS1!fecemi <> Format(Date1(0).text, "mm/yyyy") Then MsgBox "Nº folio corresponde al periodo : " & RS1!fecemi & " " & VgLinea & VgLinea & "Tiene que generar un nuevo folio", vbExclamation + vbOKOnly, Msgtitulo: RS1.Close: Set RS1 = Nothing: Exit Sub
    RS1.Close: Set RS1 = Nothing
    ...
    If porpar > 0 Then
       For i = 1 To vaSpread1.MaxRows
           vaSpread1.Row = i
           vaSpread1.Col = 1
           vaSpread1.Col = 5: precio = vaSpread1.text
           vaSpread1.Col = 18: prerea = vaSpread1.text
           vaSpread1.Col = 19: vaSpread1.text = "N"
           vaSpread1.Col = 13
    ...
    If vg_tipbase = "1" Then
       vg_db.Execute "INSERT INTO b_totcompras (toc_rutpro, toc_tipdoc, toc_numdoc, toc_codbod, toc_fecemi, toc_fecven, toc_desdoc, toc_netdoc, toc_exedoc, toc_ivadoc, toc_otrimp, toc_totdoc, toc_pendoc, toc_tipinf, toc_numinf, toc_docaso, toc_ordcom, toc_fledoc, toc_docsnc, toc_envsap, toc_fecdig, toc_fecper) " & _
                     "VALUES ('" & v_rut & "', '" & v_tipo & "'," & Val(Double1(5).text) & "," & v_bodega & ",'" & v_fecemi & "','" & v_fecven & "'," & v_totdesc & "," & vTotNet & "," & vTotExe & "," & vTotIva & "," & vTotOtr & "," & vTotTot & "," & vTotTot & ",'" & opcion & "'," & Double1(6).Value & ", '" & IIf(vg_FDC = "OC", "", Trim(vg_Guias)) & "', '" & Trim(fpText(1).text) & "'," & Double1(17).Value & ", '', '0', '" & Format(Date, "dd/mm/yyyy") & " " & Format(Time, "h:m:s") & "', " & periodo & ")"
    Else
       vg_db.Execute "INSERT INTO b_totcompras (toc_rutpro, toc_tipdoc, toc_numdoc, toc_codbod, toc_fecemi, toc_fecven, toc_desdoc, toc_netdoc, toc_exedoc, toc_ivadoc, toc_otrimp, toc_totdoc, toc_pendoc, toc_tipinf, toc_numinf, toc_docaso, toc_ordcom, toc_fledoc, toc_docsnc, toc_envsap, toc_fecdig, toc_fecper) " & _
                     "VALUES ('" & v_rut & "', '" & v_tipo & "'," & Val(Double1(5).text) & "," & v_bodega & ", '" & Format(v_fecemi, "yyyymmdd") & "','" & Format(v_fecven, "yyyymmdd") & "'," & v_totdesc & "," & vTotNet & "," & vTotExe & "," & vTotIva & "," & vTotOtr & "," & vTotTot & "," & vTotTot & ",'" & opcion & "'," & Double1(6).Value & ", '" & IIf(vg_FDC = "OC", "", Trim(vg_Guias)) & "', '" & Trim(fpText(1).text) & "'," & Double1(17).Value & ", '', '0', '" & Format(Date, "yyyy/mm/dd") & " " & Format(Time, "h:m:s") & "', " & periodo & ")"
    End If
    For cont = 1 To vaSpread1.MaxRows
        ...
        If Trim(vaSpread1.text) <> "" And IsNull((vaSpread1.text)) = False Then
            ...
            vaSpread1.Col = 11: v_descrip = LimpiaDato(Trim(Text1(0).text)) '20080417Trim(vaSpread1.text)
            vaSpread1.Col = 12: v_CtaCon = Trim(vaSpread1.text)
            vaSpread1.Col = 13: v_Rebaja = Trim(vaSpread1.text)
            If ((v_tipo = "FA" Or v_tipo = "FE") And Len(Trim(vg_Guias)) > 0) Or (v_tipo = "NC" Or v_tipo = "CE") Then v_Rebaja = "N"
            vaSpread1.Col = 15: PreC = Val(vaSpread1.text)
            vaSpread1.Col = 17: vPreDec = Val(vaSpread1.Value)
            vaSpread1.Col = 19: acepre = Trim(vaSpread1.text)
            vaSpread1.Col = 21: v_canoc = Val(vaSpread1.text)
            vaSpread1.Col = 22: v_preoc = Val(vaSpread1.text)
            vaSpread1.Col = 23: v_fecoc = IIf(Trim(vaSpread1.text) = "", 0, vaSpread1.text)
            vaSpread1.Col = 24: codsac = vaSpread1.text
            ...
            prefto = 0: prefun = 0
            If Double1(17).Value > 0 Then prefun = Round(((Double1(17).Value / Double1(13).Value) * v_total) / v_can): prefto = Round((Double1(17).Value / Double1(13).Value) * v_total, 2) 'Round((Double1(17).Value / Double1(13).Value) * v_total)
            PreC = PreC + prefun
            vg_db.Execute "INSERT INTO b_detcompras (dec_rutpro, dec_tipdoc, dec_numdoc, dec_numlin, dec_codmer, dec_canmer, dec_precom, dec_pctdes, dec_valdes, dec_ptotal, dec_descri, dec_canrec, dec_prerec, dec_mueinv, dec_prefle, dec_ptotrec, dec_acepre) " & _
                          "VALUES ('" & v_rut & "', '" & v_tipo & "', " & Double1(5).Value & ", " & cont & ", '" & codpro & "', " & v_can & ", " & v_precio & ", " & v_pctdes & ", " & v_valdes & ", " & v_total & ", '" & TipoDato(v_descrip, "") & "', " & v_canrec & ", " & v_prerec & ", '" & v_Rebaja & "', " & prefto & ", " & vTotRec & ", '" & acepre & "')"
            If vg_FDC = "OC" Then
               '-------> detalle orden de compras sac recibido
               If v_canoc = 0 Then
                  vg_db.Execute "INSERT INTO b_ocsacrecibido (ocr_rutpro, ocr_tipdoc, ocr_numdoc, ocr_codprodsgp, ocr_codprodsac, ocr_cancom, ocr_precom, ocr_canrec, ocr_fecoc, ocr_canoc, ocr_preoc) " & _
                                "VALUES ('" & v_rut & "', '" & v_tipo & "', " & Double1(5).Value & ", '" & codpro & "', '" & codsac & "', " & v_can & ", " & v_precio & ", " & v_canrec & ", Null, " & v_canoc & ", " & v_preoc & ")"
               Else
                  vg_db.Execute "INSERT INTO b_ocsacrecibido (ocr_rutpro, ocr_tipdoc, ocr_numdoc, ocr_codprodsgp, ocr_codprodsac, ocr_cancom, ocr_precom, ocr_canrec, ocr_fecoc, ocr_canoc, ocr_preoc) " & _
                                "VALUES ('" & v_rut & "', '" & v_tipo & "', " & Double1(5).Value & ", '" & codpro & "', '" & codsac & "', " & v_can & ", " & v_precio & ", " & v_canrec & ", '" & v_fecoc & "', " & v_canoc & ", " & v_preoc & ")"
               End If
            End If
            
            
            If v_Rebaja = "S" And Len(Trim(vg_Guias)) = 0 And (v_tipo <> "NC" Or v_tipo <> "CE") Then 'si el producto rebaja stock
...
'                RS1.Open "SELECT DISTINCT ppd_propon FROM b_productospmpdia WHERE ppd_cencos = '" & MuestraCasino(1) & "' AND ppd_codpro = '" & codpro & "' AND ppd_fecdia = " & Format(CDate(vg_ciedia) - 1, "yyyymmdd") & " AND ppd_propon < 1", vg_db, adOpenStatic
                RS1.Open "SELECT DISTINCT ppd_propon FROM b_productospmpdia WHERE ppd_cencos = '" & MuestraCasino(1) & "' AND ppd_codpro = '" & codpro & "' AND ppd_fecdia = " & Format(CDate(v_fecemi), "yyyymmdd") & " AND ppd_propon < 1", vg_db, adOpenStatic
                If Not RS1.EOF Then
                   '-------> Actualizar precio ultima compra, fecha ultima compra y propon
                   If vg_tipbase = "1" Then
                      vg_db.Execute "UPDATE b_productospmpdia SET ppd_propon = " & PreC & ", ppd_upreco = " & PreC & ", ppd_fecuco = cdate('" & v_fecemi & "') WHERE ppd_cencos = '" & MuestraCasino(1) & "' AND ppd_codpro = '" & codpro & "' AND ppd_fecdia = " & Format(CDate(v_fecemi), "yyyymmdd") & " AND ppd_propon < 1"
                   Else
                      vg_db.Execute "UPDATE b_productospmpdia SET ppd_propon = " & PreC & ", ppd_upreco = " & PreC & ", ppd_fecuco = '" & Format(v_fecemi, "yyyymmdd") & "' WHERE ppd_cencos = '" & MuestraCasino(1) & "' AND ppd_codpro = '" & codpro & "' AND ppd_fecdia = " & Format(CDate(v_fecemi), "yyyymmdd") & " AND ppd_propon < 1"
                   End If
                Else
                   '-------> Actualizar precio ultima compra y fecha ultima compra
                   sql1 = IIf(vg_tipbase = "1", " cdate('" & v_fecemi & "') ", " '" & Format(v_fecemi, "yyyymmdd") & "' ")
                   vg_db.Execute "UPDATE b_productospmpdia SET ppd_upreco = " & PreC & ", ppd_fecuco = " & sql1 & " WHERE ppd_cencos = '" & MuestraCasino(1) & "' AND ppd_codpro = '" & codpro & "' AND ppd_fecdia = " & Format(CDate(vg_ciedia) - 1, "yyyymmdd") & ""
                End If
                RS1.Close: Set RS1 = Nothing
    '------------Fin PMP ------------------------------------------------
    ...
    '------------Fin Actualiza -----------------------------------------------
         ...
         End If
    Next cont
    If Len(Trim(vg_Guias)) > 0 And (v_tipo = "FA" Or v_tipo = "FE" Or v_tipo = "NC" Or v_tipo = "CE") Then
        Dim StrImp As String, StrImpb As String
        StrImp = Trim(vg_Guias)
        Do While InStr(StrImp, ";") <> 0
            StrImpb = Mid(StrImp, 1, InStr(StrImp, ";") - 1)
            StrImp = IIf(Len(StrImp) > InStr(StrImp, ";"), Mid(StrImp, InStr(StrImp, ";") + 1), "")
            If vg_FDC <> "OC" And v_tipo = "FA" Or v_tipo = "FE" Then
                vg_db.Execute "UPDATE b_totcompras SET toc_docaso = " & Str(Double1(5).Value) & " WHERE toc_rutpro = '" & v_rut & "' AND toc_codbod = " & vg_codbod & " AND toc_tipdoc = 'GD' AND toc_numdoc = " & Val(StrImpb)
            ElseIf vg_FDC <> "OC" Then
                vg_db.Execute "UPDATE b_totcompras SET toc_docsnc = " & Str(Double1(5).Value) & " WHERE toc_rutpro = '" & v_rut & "' AND toc_codbod = " & vg_codbod & " AND toc_tipdoc = 'SN' AND toc_numdoc = " & Val(StrImpb)
            End If
        Loop
    End If
    ...
    For i = 1 To vaSpread1.MaxRows
        vaSpread1.Row = i
        vaSpread1.Col = 1: codpro = Trim(vaSpread1.text)
        vaSpread1.Col = 14: StrImp = Trim(vaSpread1.text)
        If Len(StrImp) <> 0 Then
           Do While InStr(StrImp, ";") <> 0
              StrImpb = Mid(StrImp, 1, InStr(StrImp, ";") - 1)
              StrImp = IIf(Len(StrImp) > InStr(StrImp, ";"), Mid(StrImp, InStr(StrImp, ";") + 1), "")
    ...
    If v_tipo = "FA" Or v_tipo = "FE" Then
        Cdif = 0
        For i = 1 To vaSpread1.MaxRows
            vaSpread1.Row = i
            vaSpread1.Col = 4: v_can = Val(vaSpread1.Value)
        ...
        Else
            ...
            Exit Sub
        End If
'        RS1.Open "SELECT toc_numdoc FROM b_totcompras WHERE toc_codbod=" & vg_codbod & " AND toc_tipdoc='SN' ORDER BY toc_numdoc DESC", vg_db, adOpenStatic
        ...
        If vg_tipbase = "1" Then
           vg_db.Execute "INSERT INTO b_totcompras (toc_rutpro, toc_tipdoc, toc_numdoc, toc_codbod, toc_fecemi, toc_fecven, toc_desdoc, toc_netdoc, toc_exedoc,toc_ivadoc, toc_otrimp, toc_totdoc, toc_pendoc, toc_tipinf, toc_numinf, toc_docaso, toc_ordcom, toc_fledoc, toc_docsnc, toc_envsap, toc_fecdig, toc_fecper) " & _
                         "VALUES ('" & v_rut & "', 'SN'," & FolioSn & "," & v_bodega & ",'" & v_fecemi & "','" & v_fecven & "'," & v_totdesc & "," & vTotNet & "," & vTotExe & "," & vTotNet & "," & vTotOtr & "," & vTotTot & "," & vTotTot & ",'" & opcion & "'," & Str(Double1(6).Value) & ", " & Str(Double1(5).Value) & ", '" & Trim(fpText(1).text) & "', 0, '', '0', '" & Format(Date, "dd/mm/yyyy") & " " & Format(Time, "h:m:s") & "', " & periodo & ")"
        Else
           vg_db.Execute "INSERT INTO b_totcompras (toc_rutpro, toc_tipdoc, toc_numdoc, toc_codbod, toc_fecemi, toc_fecven, toc_desdoc, toc_netdoc, toc_exedoc,toc_ivadoc, toc_otrimp, toc_totdoc, toc_pendoc, toc_tipinf, toc_numinf, toc_docaso, toc_ordcom, toc_fledoc, toc_docsnc, toc_envsap, toc_fecdig, toc_fecper) " & _
                         "VALUES ('" & v_rut & "', 'SN'," & FolioSn & "," & v_bodega & ",'" & Format(v_fecemi, "yyyymmdd") & "','" & Format(v_fecven, "yyyymmdd") & "'," & v_totdesc & "," & vTotNet & "," & vTotExe & "," & vTotNet & "," & vTotOtr & "," & vTotTot & "," & vTotTot & ",'" & opcion & "'," & Str(Double1(6).Value) & ", " & Str(Double1(5).Value) & ", '" & Trim(fpText(1).text) & "', 0, '', '0', '" & Format(Date, "yyyymmdd") & " " & Format(Time, "h:m:s") & "', " & periodo & ")"
        End If
        For i = 1 To vaSpread1.MaxRows
            vaSpread1.Row = i
            vaSpread1.Col = 1: codpro = Trim(vaSpread1.text)
...
Case 3 '-------> Borrar
    ...
    If CierrePeriodo(Format(Date1(0).text, "yyyymmdd"), v_bodega, 6) And Format(CDate(vg_ciedia) - 1, "mm/yyyy") = Format(CDate(Date1(0).Value), "mm/yyyy") Then MsgBox "No puede eliminar documentos anteriores a la última toma de inventario.", vbExclamation + vbOKOnly, Msgtitulo: Exit Sub
    If CDate(Date1(0).Value) < CDate(vg_ciedia) And Format(CDate(vg_ciedia) - 1, "mm/yyyy") = Format(CDate(Date1(0).Value), "mm/yyyy") Then MsgBox "No puede eliminar documentos, día esta cerrado...", vbExclamation + vbOKOnly, Msgtitulo: Exit Sub
    Borra_Datos
    Frame2.Enabled = True
    Frame3.Enabled = True
    Frame6.Enabled = True
...
On Error GoTo Man_Error
Dim codigo As String, v_bodega As Long, v_cant As Double, actbod As Boolean, tipaux As String, rut As String, codpro As String
...
If MsgBox("¿Desea Eliminar Documento?", vbQuestion + vbYesNo, Msgtitulo) = vbNo Then Exit Sub
    ...
    actbod = True
    vg_db.BeginTrans
    RS1.Open "SELECT toc_docaso FROM b_totcompras WHERE toc_rutpro = '" & rut & "' AND toc_tipdoc = '" & codigo & "' AND toc_numdoc = " & Num & " AND toc_codbod = " & vg_codbod & "", vg_db, adOpenStatic
    If Not RS1.EOF Then
        tipaux = ""
        If codigo = "FA" Or codigo = "FE" Then tipaux = "GD"
        If codigo = "NC" Or codigo = "CE" Then tipaux = "SN"
        If tipaux = "SN" Then
           vg_db.Execute "UPDATE b_totcompras SET toc_docsnc = '' WHERE toc_rutpro = '" & rut & "' AND toc_tipdoc = '" & tipaux & "' AND toc_docsnc = '" & Trim(Str(Num)) & "' AND toc_codbod = " & vg_codbod & ""
        ElseIf tipaux = "GD" Then
           vg_db.Execute "UPDATE b_totcompras SET toc_docaso = '' WHERE toc_rutpro = '" & rut & "' AND toc_tipdoc = '" & tipaux & "' AND toc_docaso = '" & Trim(Str(Num)) & "' AND toc_codbod = " & vg_codbod & ""
        End If
    ...
    RS1.Open "SELECT toc_numdoc, toc_docsnc FROM b_totcompras WHERE toc_rutpro = '" & rut & "' AND toc_tipdoc = 'SN' AND toc_docaso = '" & Trim(Str(Num)) & "' AND toc_codbod = " & vg_codbod & "", vg_db, adOpenStatic
    If Not RS1.EOF Then
       If Trim(RS1!toc_docsnc) <> "" And Not IsNull(RS1!toc_docsnc) Then RS1.Close: Set RS1 = Nothing: vg_db.RollbackTrans: MsgBox "Documento esta asociado Solicitud de Nota Credito... ", vbInformation + vbOKOnly, Msgtitulo: Exit Sub
       vg_db.Execute "DELETE FROM b_detcomprasimp WHERE imd_rutdoc = '" & rut & "' AND imd_tipdoc = 'SN' AND imd_numdoc = " & RS1!toc_numdoc
       vg_db.Execute "DELETE FROM b_detcompras WHERE dec_rutpro = '" & rut & "' AND dec_tipdoc = 'SN' AND dec_numdoc = " & RS1!toc_numdoc
       vg_db.Execute "DELETE FROM b_totcompras WHERE toc_rutpro = '" & rut & "' AND toc_tipdoc = 'SN' AND toc_numdoc = " & RS1!toc_numdoc & " AND toc_codbod = " & vg_codbod & ""
    End If
    RS1.Close: Set RS1 = Nothing
    ...
    If actbod Then
        For i = 1 To vaSpread1.MaxRows
            ...
            If Trim(vaSpread1.text) = "S" Then
                vaSpread1.Row = i
                vaSpread1.Col = 1: codigo = Trim(vaSpread1.text): codpro = codpro & "'" & Trim(vaSpread1.text) & "',"
                vaSpread1.Col = 9: v_cant = vaSpread1.text
                If codigo <> "NC" Or codigo <> "CE" Then
                    '-------> Validar si existen diferencia en bodega
                    RS1.Open "SELECT bod_canmer FROM b_bodegas WHERE bod_codbod = " & v_bodega & " AND bod_codpro = '" & codigo & "'", vg_db, adOpenStatic
                    If Not RS1.EOF Then If (RS1!bod_canmer - IIf(v_cant < 0, (v_cant * -1), v_cant)) <= -1 Then RS1.Close: Set RS1 = Nothing: vg_db.RollbackTrans: MsgBox "Documento no puede ser eliminado. Existen diferencia ...", vbExclamation + vbOKOnly, Msgtitulo: Exit Sub
                    RS1.Close: Set RS1 = Nothing
...
'*    If Trim(CodPro) <> "" Then RecalPrecioDoc Format(Date1(0).text, "yyyymmdd"), fg_codigocbo(Combo2, 1, 1, 0), CodPro
    fpText(0).text = "": fpayuda(0).Caption = ""
    Double1(5).text = "": Double1(6).text = ""
    Double1(12).text = "": Double1(13).text = "": Double1(14).text = "": Double1(15).text = "": Double1(16).text = "": Double1(17).text = ""
...
Dim i As Long, cCta As String, cPro As String, fecoc As String
Select Case Button.Index
Case 1
    StopObjeto False
    vg_nombre = "": vg_codigo = ""
...
'    SendKeys "+{BREAK}"
    ...
    If Not RS1.EOF Then
        If IsNull(pro_ctrsto) Then Frame5.Enabled = False: MsgBox "Producto no tiene asignado, el Movimiento...", vbExclamation + vbOKOnly, Msgtitulo: vaSpread1.SetActiveCell 1, vaSpread1.ActiveRow: Frame5.Enabled = True: Exit Sub
        ...
        vaSpread1.Col = 2: vaSpread1.text = RS1!pro_nombre '20080417: Text1(0).text = Trim(RS1!pro_nombre)
        vaSpread1.Col = 3: vaSpread1.text = RS1!uni_nomcor
        vaSpread1.Col = 12: vaSpread1.text = RS1!pro_ctacon
        vaSpread1.Col = 11: vaSpread1.text = "" '20080417Text1(0).text
        vaSpread1.Col = 18: vaSpread1.text = RS1!ppd_propon
        For i = 4 To 10: vaSpread1.Col = i: vaSpread1.text = Format(0, fg_Pict(9, vg_DCa)): Next i
        If Trim(RS1!pro_ctacon) = "" Or IsNull(RS1!pro_ctacon) Then RS1.Close: Set RS1 = Nothing: MsgBox "El producto no tiene asosiada una cuenta contable...", vbExclamation + vbOKOnly, Msgtitulo: vaSpread1.SetActiveCell 1, vaSpread1.ActiveRow: Exit Sub
        vaSpread1.Col = 13: vaSpread1.text = IIf(RS1!pro_ctrsto = 1, "S", "N")
    Else
       '-------> bloquear celda
...
Case 2
    ...
    vaSpread1.Row = vaSpread1.ActiveRow
    vaSpread1.Col = 23: fecoc = "": fecoc = Trim(vaSpread1.text)
    vaSpread1.Col = 1
...
vaSpread1.Col = 14: vaSpread1.text = ""
RS6.Open "SELECT a.*, b.* FROM b_productosimp a, a_impuesto b WHERE a.ipr_codimp=b.imp_codigo AND a.ipr_codpro='" & codpro & "'", vg_db, adOpenStatic
Do While Not RS6.EOF
   vaSpread1.Col = vaSpread1.ActiveCol: vaSpread1.Row = Row
   vaSpread1.Col = 14: vaSpread1.text = vaSpread1.text & Trim(Str(RS6!ipr_codimp)) & "&"
   vaSpread1.Col = 14: vaSpread1.text = vaSpread1.text & Trim(Str(IIf(IsNull(RS6!imp_pctimp), 0, RS6!imp_pctimp))) & "&"
   vaSpread1.Col = 14: vaSpread1.text = vaSpread1.text & Trim(Str(RS6!imp_inccos)) & ";"
   RS6.MoveNext
Loop
RS6.Close: Set RS6 = Nothing
End Sub
...
If AdvanceNext = True And codigo <> "" And Nombre <> "" Then
   ...
   vaSpread1.MaxRows = vaSpread1.MaxRows + 1: vaSpread1.SetActiveCell 1, vaSpread1.MaxRows
   vaSpread1.Row = vaSpread1.MaxRows
   For i = 4 To 10: vaSpread1.Col = i: vaSpread1.Lock = True: Next i
End If
End Sub
...
Dim fecoc As String, i As Long, codsac As String, cPro As String
If vaSpread1.MaxRows < 1 Or Col <> 1 Or vg_FDC <> "OC" Then Exit Sub
vaSpread1.Row = Row
vaSpread1.Col = 23: fecoc = "": fecoc = Trim(vaSpread1.text)
vaSpread1.Col = 24: fecoc = "": codsac = Trim(vaSpread1.text)
vaSpread1.Col = 1
...
'         If vaSpread1.Lock = True Then vaSpread1.MaxRows = vaSpread1.MaxRows + 1
         ...
         vaSpread1.Col = 3: vaSpread1.text = RS1!uni_nomcor
         vaSpread1.Col = 12: vaSpread1.text = RS1!pro_ctacon
         vaSpread1.Col = 11: vaSpread1.text = ""
         If Trim(RS1!pro_ctacon) = "" Or IsNull(RS1!pro_ctacon) Then RS1.Close: Set RS1 = Nothing: MsgBox "El producto no tiene asosiada una cuenta contable...", vbExclamation + vbOKOnly, Msgtitulo: vaSpread1.SetActiveCell 1, vaSpread1.ActiveRow: Exit Sub
         vaSpread1.Col = 13: vaSpread1.text = IIf(RS1!pro_ctrsto = 1, "S", "N")
     Else
        '-------> bloquear celda
...
Dim codigo As String, Switch As Boolean, encuentra As Boolean, canrec As Double, cPro As String, Nombre As String
...
With vaSpread1
    ...
    .Col = 8: totitem = Val(vaSpread1.Value)
    subtot = precio * cantidad
    vaSpread1.EditModePermanent = False
    Select Case Col
    Case 4
        .Col = 4: canfac = Val(vaSpread1.Value): vaSpread1.Col = 9: vaSpread1.Value = canfac
        If cantidad > 0 And totitem > 0 And precio = 0 Then
           .Col = 5: vaSpread1.Value = Round((totitem / cantidad), 2): precio = Round((totitem / cantidad), 2)
           .Col = 10: vaSpread1.Value = Round((totitem / cantidad), 2)
           .Col = 17: vaSpread1.Value = Round((totitem / cantidad), 3)
           subtot = precio * cantidad
        End If
    Case 5
        .Col = 5: valfac = Val(vaSpread1.Value): vaSpread1.Col = 10: vaSpread1.Value = valfac: vaSpread1.Col = 17: vaSpread1.Value = valfac
    Case 6
        .Col = 7: vaSpread1.Value = subtot * (Descto / 100)
        .Col = 8: vaSpread1.Value = Round(subtot - ((cantidad * precio) * (Descto / 100)), 0)
    Case 7
        .Col = 6: vaSpread1.Value = (DesctoFinal * 100) / subtot
        .Col = 6: Descto = Val(vaSpread1.Value)
        If Descto >= 99.99 Then
            ...
            .Col = 7: vaSpread1.Value = subtot * (Descto / 100)
        End If
        .Col = 8: vaSpread1.Value = Round(subtot - (subtot * (Descto / 100)), 0)
    Case 8
        If cantidad <= 0 Then Exit Sub
        .Col = 5: vaSpread1.Value = Round((totitem / cantidad), 2)
        .Col = 10: vaSpread1.Value = Round((totitem / cantidad), 2)
        .Col = 17: vaSpread1.Value = Round((totitem / cantidad), 3)
    Case 9
        .Col = 9: canrec = vaSpread1.Value
...
Case 1 And vaSpread1.Lock = False
    ...
    If vaSpread1.text = "" Then
       ...
       codigo = vg_codigo: vaSpread1.text = vg_codigo
    End If
    ...
    Next i
    RS1.Open "SELECT DISTINCT a.pro_codigo, a.pro_nombre, a.pro_ctacon, a.pro_ctrsto, b.uni_nomcor, a.pro_facing, a.pro_facsto, c.ppd_propon " & _
             "FROM  b_productos a, a_unidad b, b_productospmpdia c, a_tiposervicio d, b_clientes e " & _
             "WHERE (d.tis_codigo = e.cli_codtis OR a.pro_maepro < 1) AND e.cli_codigo = '" & MuestraCasino(1) & "' AND (d.tis_codigo = a.pro_maepro OR a.pro_maepro < 1) AND a.pro_codigo = c.ppd_codpro AND a.pro_coduni = b.uni_codigo " & _
             "AND   a.pro_codigo = '" & codigo & "' " & _
             "AND  (a.pro_fecven > " & Format(Date, "yyyymmdd") & " OR a.pro_fecven = 0) AND c.ppd_cencos = '" & MuestraCasino(1) & "' AND c.ppd_fecdia = " & Format(CDate(vg_ciedia) - 1, "yyyymmdd") & "", vg_db, adOpenStatic
    If Not RS1.EOF Then
       If IsNull(pro_ctrsto) Then Frame5.Enabled = False: MsgBox "Producto no tiene asignado, el Movimiento...", vbExclamation + vbOKOnly, Msgtitulo: vaSpread1.SetActiveCell 1, vaSpread1.ActiveRow: Frame5.Enabled = True: Exit Sub
       If RS1!pro_facing = 0 Or RS1!pro_facsto = 0 Then RS1.Close: Set RS1 = Nothing: MsgBox "Factor del producto en cero...", vbExclamation + vbOKOnly, Msgtitulo: vaSpread1.SetActiveCell 1, vaSpread1.ActiveRow: Exit Sub
       vaSpread1.Row = Row
       cPro = RS1!pro_codigo
       ...
       vaSpread1.Col = 18: vaSpread1.text = RS1!ppd_propon
       vaSpread1.Col = 4
       If Trim(vaSpread1.text) = "" Then For i = 4 To 10: vaSpread1.Col = i: vaSpread1.text = Format(0, fg_Pict(9, vg_DCa)): Next i
       If Trim(RS1!pro_ctacon) = "" Or IsNull(RS1!pro_ctacon) Then RS1.Close: Set RS1 = Nothing: MsgBox "El producto no tiene asosiada una cuenta contable...", vbExclamation + vbOKOnly, Msgtitulo: vaSpread1.SetActiveCell 1, vaSpread1.ActiveRow: Exit Sub
       vaSpread1.Col = 13: vaSpread1.text = IIf(RS1!pro_ctrsto = 1, "S", "N")
       i = 4
    ...
    vaSpread1.SetActiveCell i, vaSpread1.Row
    vaSpread1.Refresh
    If vaSpread1.Enabled = True Then On Error Resume Next: vaSpread1.SetFocus
End Select
vaSpread1.ProcessTab = True
est1 = False: MostrarImpuesto NewRow
End Sub
...
StrImp = "": StrImpb = ""
vaSpread1.Row = Fila
vaSpread1.Col = IIf(Trim(fg_codigocbo(Combo2, 0, 2, "")) <> "CG", 2, 11) '20080417: Text1(0).text = vaSpread1.text
vaSpread1.Col = 8: CosTot = Val(vaSpread1.Value)
vaSpread1.Col = 14
...
If Len(StrImp) <> 0 Then
   Do While InStr(StrImp, ";") <> 0
      ...
      If vaSpread2.SearchCol(1, 0, vaSpread2.MaxRows, CStr(codimp), SearchFlagsNone) <> -1 Then
         ...
         If PctI > 0 Then
            est1 = True: est2 = True
            vaSpread2.Col = 2: vaSpread2.text = "1": vaSpread2.Col = 4: vaSpread2.text = Format(PctI, fg_Pict(3, 2)) & " %": vaSpread2.Col = 7: vaSpread2.text = PctI
            est1 = False: est2 = False
         Else
            est1 = True: est2 = True
            vaSpread2.Col = 2: vaSpread2.text = "0": vaSpread2.Col = 4: vaSpread2.text = "0 %": vaSpread2.Col = 7: vaSpread2.text = 0
            vaSpread2.Col = 4: vaSpread2.text = "0 %": vaSpread2.Col = 7: vaSpread2.text = 0
            est1 = False: est2 = False
         End If
         vaSpread2.Col = 7: valimp = IIf(fg_codigocbo(Combo2, 0, 2, "") = "BH" And codimp <> 1, Val(vaSpread2.Value), (Val(vaSpread2.Value) / 100))
         vaSpread2.Col = 5
         If valimp > 0 Then
            vaSpread2.text = IIf(fg_codigocbo(Combo2, 0, 2, "") = "BH" And codimp <> 1, Format(Round(((CosTot / ((100 - valimp) / 100))) / valimp), fg_Pict(6, 0)), Format(valimp * CosTot, fg_Pict(6, 0)))
         Else
            vaSpread2.text = 0
         End If
...
vaSpread2.Row = Row
vaSpread2.Col = 1
If vaSpread2.Value = 1 Or vaSpread2.Value = 11 Then vaSpread2.Col = 2: vaSpread2.text = "1": Exit Sub
vaSpread2.Col = 2
If ButtonDown = 0 Then
   vaSpread2.Col = 4: est2 = True: vaSpread2.text = "0 %"
   vaSpread2.Col = 5: est2 = True: vaSpread2.text = Format(0, fg_Pict(6, 0))
   vaSpread2.Col = 7: est2 = True: vaSpread2.text = 0
   vaSpread1.Row = vaSpread1.ActiveRow: vaSpread1.Col = 14: StrImp = Trim(vaSpread1.text): vaSpread1.text = ""
   If Len(StrImp) <> 0 Then
      vaSpread2.Col = 1
      Do While InStr(StrImp, ";") <> 0
         StrImpb = Mid(StrImp, 1, InStr(StrImp, ";") - 1)
         ...
         End If
         CosI = Val(Mid(StrImpb, 1))
         vaSpread1.Col = 14: vaSpread1.text = vaSpread1.text & Trim(codimp) & "&"
         vaSpread1.Col = 14: vaSpread1.text = vaSpread1.text & Trim(Str(PctI)) & "&"
         vaSpread1.Col = 14: vaSpread1.text = vaSpread1.text & Trim(Str(CosI)) & ";"
      Loop
      SumarTotales
   End If
ElseIf ButtonDown = 1 Then
   ...
   For i = 1 To UBound(Impuestos)
       If Impuestos(i, 1) = vaSpread2.text Then
          vaSpread2.Col = 4: est2 = True: vaSpread2.text = Impuestos(i, 3) & " %"
          vaSpread2.Col = 5: est2 = True: vaSpread2.text = Format(0, fg_Pict(6, 0))
          vaSpread2.Col = 7: est2 = True: vaSpread2.text = Impuestos(i, 3)
...
Dim codimp As Long, valimp As Double, totpro As Double, porimp As Double
codimp = 0: valimp = 0: totpro = 0: porimp = 0
'-------> Devolver impuesto si es modificable
vaSpread1.Row = vaSpread1.ActiveRow
vaSpread1.Col = 8: totpro = vaSpread1.text
vaSpread1.Col = 14: StrImp = Trim(vaSpread1.text): vaSpread1.text = ""
'-------> Calcular & impuesto
vaSpread2.Row = Row
vaSpread2.Col = 5: valimp = vaSpread2.text
...
If Len(StrImp) <> 0 Then
   Do While InStr(StrImp, ";") <> 0
      ...
      If codimp = vaSpread2.text Then
         PctI = porimp
         vaSpread2.Col = 6: CosI = vaSpread2.text
      Else
         PctI = Val(Mid(StrImpb, 1, InStr(StrImpb, "&") - 1)): StrImpb = Mid(StrImpb, InStr(StrImpb, "&") + 1)
         CosI = Val(Mid(StrImpb, 1))
      End If
...
fpText(0).TabStop = est: fpText(1).TabStop = est
Combo2(0).TabStop = est: Combo2(1).TabStop = est
Double1(5).TabStop = est: Double1(6).TabStop = est
Double1(12).TabStop = est: Double1(13).TabStop = est
Double1(14).TabStop = est: Double1(15).TabStop = est
Double1(16).TabStop = est: Double1(17).TabStop = est
Date1(0).TabStop = est
