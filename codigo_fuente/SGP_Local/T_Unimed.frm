...
Begin VB.Form T_Unimed 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "T_Unimed.frx":1906
         Left            =   2085
         List            =   "T_Unimed.frx":1910
...
With vaSpread1
    ...
    If modo = "A" Then
        vg_db.BeginTrans
        RS1.Open RutinaLectura.UnidadMedida(1, 0, ""), vg_db, adOpenStatic
        If Not RS1.EOF Then RS1.MoveFirst: codigo = RS1!unm_codigo + 1 Else codigo = 1
        RS1.Close: Set RS1 = Nothing
        vg_db.Execute "INSERT INTO a_unidadmed (unm_codigo, unm_nombre, unm_nomcor) VALUES (" & codigo & ", '" & Trim(Nombre) & "', '" & Trim(NomCor) & "')"
        vg_db.CommitTrans
        .Col = 1: .Value = codigo
    Else
        vg_db.BeginTrans
        vg_db.Execute "UPDATE a_unidadmed SET unm_nombre='" & Trim(Nombre) & "', unm_nomcor='" & Trim(NomCor) & "' WHERE unm_codigo=" & codigo
        vg_db.CommitTrans
    End If
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
    RS2.Open RutinaLectura.UnidadMedida(3, 0, UCase(LimpiaDato(fpText1.text))), vg_db, adOpenStatic
ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
    RS2.Open RutinaLectura.UnidadMedida(4, 0, UCase(LimpiaDato(fpText1.text))), vg_db, adOpenStatic
End If
With vaSpread1
    ...
    If Not RS2.EOF Then
       Do While Not RS2.EOF
          ...
          .Col = 1
          .TypeHAlign = 0
          .Value = RS2!unm_codigo
          .Col = 2
          .Value = Trim(RS2!unm_nombre)
          .Col = 3
          .Value = Trim(RS2!unm_nomcor)
          RS2.MoveNext
       Loop
       Gl_Ac_Botones Me, 1, IIf(vg_modprod = True, 1, 6), modo
    End If
...
With vaSpread1
    .MaxRows = 0
    RS2.Open RutinaLectura.UnidadMedida(2, 0, ""), vg_db, adOpenStatic
    Do While Not RS2.EOF
        .MaxRows = .MaxRows + 1
        .Row = .MaxRows
        .Col = 1: .Value = RS2!unm_codigo
        .Col = 2: .Value = Trim(RS2!unm_nombre)
        .Col = 3: .Value = Trim(RS2!unm_nomcor)
        RS2.MoveNext
    Loop
    RS2.Close: Set RS2 = Nothing
    Gl_Ac_Botones Me, 1, IIf(vg_modprod = True, 1, 6), modo
    If vg_modprod = False Then
       .Col = 1: .Col2 = 3: .Row = 1: .Row2 = .MaxRows
       .BlockMode = True: .Lock = True: .Protect = True: .BlockMode = False
    End If
    Label2.Caption = Format(.MaxRows, fg_Pict(7, 0)) & " Registro"
End With
...
With vaSpread1
    .Row = .ActiveRow
    .Col = 1: codigo = Val(.Value)
    RS1.Open RutinaLectura.UnidadMedida(2, codigo, ""), vg_db, adOpenStatic
    If Not RS1.EOF Then
       .Col = 2: .Value = Trim(RS1!unm_nombre)
       .Col = 3: .Value = Trim(RS1!unm_nomcor)
    End If
    RS1.Close: Set RS1 = Nothing
End With
OpGr = False
