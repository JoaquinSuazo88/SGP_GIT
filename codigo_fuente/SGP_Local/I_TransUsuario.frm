...
Set RS = vg_db.Execute("sgp_Sel_Usuaurio_Trasacciones")
...
Set RS = vg_db.Execute("sgp_Sel_OpSistema")
Do While Not RS.EOF
...
Set RS = vg_db.Execute("sgp_Sel_LogConceptos")
Do While Not RS.EOF
    
    Combo1(2).AddItem RS!loc_descripcion & Space(150) & "(" & fg_pone_cero(RS!loc_Id, 3) & ")"
    RS.MoveNext
...
Select Case Index
    ...
    Case 0
        ...
        Set RS = vg_db.Execute("sgp_Sel_XmlTransccionesUsuarios '" & MyBuffer & "', '" & cDateIni & "', '" & cDateFin & "', '" & IIf(cFunSis = "0", "", cFunSis) & "', " & cTipOpe & "")
        If Not RS.EOF Then
