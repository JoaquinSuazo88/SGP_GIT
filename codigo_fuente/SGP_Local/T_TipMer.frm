...
With vaSpread1
    ...
    If modo = "A" Then
        vg_db.BeginTrans
        RS1.Open RutinaLectura.TipoAjuste(1, 0, "", 0), vg_db, adOpenStatic
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
   RS2.Open RutinaLectura.TipoAjuste(3, 0, UCase(LimpiaDato(fpText1.text)), 0), vg_db, adOpenStatic
ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
   sql1 = IIf(vg_tipbase = "1", " UCASE(aju_nombre) ", " UPPER(aju_nombre) ")
   RS2.Open RutinaLectura.TipoAjuste(4, 0, UCase(LimpiaDato(fpText1.text)), 0), vg_db, adOpenStatic
End If
With vaSpread1
...
With vaSpread1
    ...
    RS2.Open RutinaLectura.TipoAjuste(2, 0, "", 0), vg_db, adOpenStatic
    Do While Not RS2.EOF
        
        .MaxRows = .MaxRows + 1
        .Row = .MaxRows
        .Col = 1: .TypeHAlign = 1: .Value = RS2!aju_codigo
    ...
    Gl_Ac_Botones Me, 1, IIf(.MaxRows = 0, 6, 6), modo 'IIf(.MaxRows = 0, 2, 1), modo
...
With vaSpread1
    ...
    RS1.Open RutinaLectura.TipoAjuste(2, codigo, "", 0), vg_db, adOpenStatic
    If Not RS1.EOF Then
