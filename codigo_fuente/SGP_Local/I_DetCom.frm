...
Select Case Index
    ...
    Case 0
        ...
        RS1.Open RutinaLectura.Proveedor(1, Trim(fpText1(0).text), ""), vg_db, adOpenStatic
        If Not RS1.EOF Then
...
'-------> Cargar Combo Familia Producto
CargarDatoCombo Combo1, 1, "a_tipopro", "tip_", "TipPro", "N"
'-------> Cargar Combo Productos
CargarDatoCombo Combo1, 2, "b_productos", "pro_", "Prod", "A"
'-------> Cargar Combo tipo Documento
CargarDatoCombo Combo1, 3, "a_tipodocumento", "tdo_", "Gen", "A"
...
Select Case Button.Index
    ...
    Case 1 '------- Previsualizar
        ...
        If Check1(2).Value = 1 Then
           ...
           If Combo1(1).ListIndex = -1 Then MsgBox "Tipo de producto no valido...", vbExclamation, MsgTitulo: Exit Sub
           paso = paso + 1
        ...
        If Check1(3).Value = 1 Then
           ...
           If Combo1(2).ListIndex = -1 Then MsgBox "Producto no valido...", vbExclamation, MsgTitulo: Exit Sub
           paso = paso + 1
        ...
        If Check1(5).Value = 1 Then
           ...
           If Combo1(3).ListIndex = -1 Then MsgBox "Tipo de documento no valido...", vbExclamation, MsgTitulo: Exit Sub
           paso = paso + 1
