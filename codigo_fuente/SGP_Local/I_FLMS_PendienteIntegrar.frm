...
Begin VB.Form I_FLMS_PendienteIntegrar 
   ...
   End
End
Attribute VB_Name = "I_FLMS_PendienteIntegrar"
...
Set RS = vg_db.Execute("SGP_S_ReporteDatosPendientesIntegracion_FLMStoSGP " & Format(fpDateTime1(0).Value, "yyyymmdd") & ", " & Format(fpDateTime1(1).Value, "yyyymmdd") & ", '" & TipoDocumento & "'")
...
NombreArchivoExcel = "ReporteDatosPendientesIntegracion_" & Format(Date, "yyyymmdd") & "_" & Format(Time, "HHMMSS")
Generar_ArchivoExcel "SGP_S_ReporteDatosPendientesIntegracion_FLMStoSGP " & Format(fpDateTime1(0).Value, "yyyymmdd") & ", " & Format(fpDateTime1(1).Value, "yyyymmdd") & ", '" & TipoDocumento & "'", dir_trabajo_Inf & "FLMStoSGP\", NombreArchivoExcel
