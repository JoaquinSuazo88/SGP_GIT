...
Begin VB.Form M_Pacien 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(0)=   "sombra(0)"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "sombra(1)"
      ...
      Tab(1).Control(15)=   "fpayuda(4)"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "fpayuda(1)"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "Image1(1)"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "Label1(18)"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "fpayuda(0)"
      Tab(1).Control(19).Enabled=   0   'False
      Tab(1).Control(20)=   "Image1(0)"
      Tab(1).Control(20).Enabled=   0   'False
      Tab(1).Control(21)=   "fpayuda(2)"
      Tab(1).Control(21).Enabled=   0   'False
      Tab(1).Control(22)=   "Date1(1)"
      Tab(1).Control(22).Enabled=   0   'False
      Tab(1).Control(23)=   "Date1(0)"
      Tab(1).Control(23).Enabled=   0   'False
      Tab(1).Control(24)=   "fpLongInteger1(0)"
      Tab(1).Control(24).Enabled=   0   'False
      Tab(1).Control(25)=   "fpLongInteger1(1)"
      Tab(1).Control(25).Enabled=   0   'False
      Tab(1).Control(26)=   "fpText(3)"
      Tab(1).Control(26).Enabled=   0   'False
      Tab(1).Control(27)=   "fpText(2)"
      Tab(1).Control(27).Enabled=   0   'False
      Tab(1).Control(28)=   "fpText(6)"
      Tab(1).Control(28).Enabled=   0   'False
      Tab(1).Control(29)=   "fpText(0)"
      Tab(1).Control(29).Enabled=   0   'False
      Tab(1).Control(30)=   "fpText(4)"
      Tab(1).Control(30).Enabled=   0   'False
      Tab(1).Control(31)=   "fpText(5)"
      Tab(1).Control(31).Enabled=   0   'False
      Tab(1).Control(32)=   "fpText(1)"
      Tab(1).Control(32).Enabled=   0   'False
      Tab(1).Control(33)=   "Option1(0)"
      Tab(1).Control(33).Enabled=   0   'False
      Tab(1).Control(34)=   "Option1(1)"
      Tab(1).Control(34).Enabled=   0   'False
      Tab(1).Control(35)=   "Combo1(1)"
...
Combo1(1).Clear
Combo1(1).AddItem "Masculino" & Space(150) & "(M)"
Combo1(1).AddItem "Femenino" & Space(150) & "(F)"
MoverPacientes
est = False
End Sub
...
If Not RS.EOF Then
   Do While Not RS.EOF
      vaSpread1.Row = i
      vaSpread1.Col = 1: vaSpread1.text = IIf(IsNull(RS!grp_nombre), "", Trim(RS!grp_nombre))
      vaSpread1.Col = 2: vaSpread1.text = IIf(IsNull(RS!pac_nrocam), "", Trim(RS!pac_nrocam))
      vaSpread1.Col = 3: vaSpread1.text = IIf(IsNull(RS!pac_codigo), "", fg_PintaRut(RS!pac_codigo))
      vaSpread1.Col = 4: vaSpread1.Lock = True: vaSpread1.text = IIf(IsNull(RS!pac_estado), "", Trim(RS!pac_estado))
      vaSpread1.Col = 5: vaSpread1.text = IIf(IsNull(RS!pac_appaterno), "", Trim(RS!pac_appaterno))
      vaSpread1.Col = 6: vaSpread1.text = IIf(IsNull(RS!pac_apmaterno), "", Trim(RS!pac_apmaterno))
      vaSpread1.Col = 7: vaSpread1.text = IIf(IsNull(RS!pac_nombre), "", Trim(RS!pac_nombre))
      vaSpread1.Col = 8: vaSpread1.text = IIf(Trim(RS!pac_sexo) = "M", "Masculino", "Femenino")
      vaSpread1.Col = 9: vaSpread1.text = IIf(IsNull(RS!reg_nombre), "", Trim(RS!reg_nombre))
      vaSpread1.Col = 10: vaSpread1.text = IIf(IsNull(RS!pac_fecing), "", Trim(RS!pac_fecing))
      vaSpread1.Col = 11: vaSpread1.text = IIf(IsNull(RS!pac_fecalt), "", Trim(RS!pac_fecalt))
      vaSpread1.Col = 12: vaSpread1.text = IIf(IsNull(RS!pac_presdiet), "", Trim(RS!pac_presdiet))
      vaSpread1.Col = 13: vaSpread1.text = IIf(IsNull(RS!pac_comentario), "", Trim(RS!pac_comentario))
      vaSpread1.Col = 14: vaSpread1.text = IIf(IsNull(RS!pac_origen), "", Trim(RS!pac_origen))
      RS.MoveNext: i = i + 1
   Loop
   SSTab1.TabEnabled(1) = True
   vaSpread1.Row = 1: vaSpread1.Col = 3: codigo = fg_DespintaRut(vaSpread1.text)
...
vg_db.BeginTrans
vg_db.Execute "DELETE * FROM b_pacientes WHERE pac_codigo='" & codigo & "'"
vaSpread1.Row = vaSpread1.ActiveRow
