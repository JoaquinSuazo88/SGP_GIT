...
Begin VB.Form T_Unienv 
   ...
   Begin FPSpread.vaSpread vaSpread1 
      ...
      EndProperty
      MaxCols         =   3
      SpreadDesigner  =   "T_Unienv.frx":0000
      ScrollBarTrack  =   3
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "T_Unienv.frx":1906
         Left            =   1875
         List            =   "T_Unienv.frx":1910
...
With vaSpread1
    ...
    If modo = "A" Then
        vg_db.BeginTrans
        RS1.Open RutinaLectura.Unidad(1, 0, ""), vg_db, adOpenStatic
        If Not RS1.EOF Then RS1.MoveFirst: codigo = RS1!uni_codigo + 1 Else codigo = 1
...
If Combo1.ItemData(Combo1.ListIndex) = 0 Then
    RS2.Open RutinaLectura.Unidad(3, 0, UCase(LimpiaDato(fpText1.text))), vg_db, adOpenStatic
ElseIf Combo1.ItemData(Combo1.ListIndex) = 1 Then
    RS2.Open RutinaLectura.Unidad(4, 0, UCase(LimpiaDato(fpText1.text))), vg_db, adOpenStatic
End If
With vaSpread1
    ...
    If Not RS2.EOF Then
       Do While Not RS2.EOF
          .Row = i
          i = i + 1
          .Col = 1: .Value = RS2!uni_codigo
          .Col = 2: .Value = Trim(RS2!uni_nombre)
          .Col = 3: .Value = Trim(RS2!uni_nomcor)
          RS2.MoveNext
       Loop
       Gl_Ac_Botones Me, 1, IIf(vg_modprod = True, 1, 6), modo
    End If
...
With vaSpread1
    .MaxRows = 0
    RS2.Open RutinaLectura.Unidad(2, 0, ""), vg_db, adOpenStatic
    Do While Not RS2.EOF
        .MaxRows = .MaxRows + 1
        .Row = .MaxRows
        .Col = 1: .Value = RS2!uni_codigo
...
With vaSpread1
    .Row = .ActiveRow
    .Col = 1: codigo = Val(.Value)
    RS1.Open RutinaLectura.Unidad(2, codigo, ""), vg_db, adOpenStatic
    If Not RS1.EOF Then
       .Col = 2: .Value = Trim(RS1!uni_nombre)
       .Col = 3: .Value = Trim(RS1!uni_nomcor)
    End If
    RS1.Close: Set RS1 = Nothing
End With
OpGr = False
