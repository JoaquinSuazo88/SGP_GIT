...
If Not RS1.EOF Then
   Do While Not RS1.EOF
      ...
      If rootnode.Children = 0 Then
         RS2.Open "SELECT DISTINCT car_previo FROM  a_recetacatdie WHERE car_previo = " & RS1!car_codigo & "", vg_db, adOpenStatic
         If Not RS2.EOF Then
...
If Not RS1.EOF Then
   Do While Not RS1.EOF
      ...
      '------- agregar un nodo hijo postizo, si fuera necesario
      If rootnode.Children = 0 Then
         RS2.Open "SELECT DISTINCT tip_previo FROM a_recetatippla WHERE tip_previo = " & RS1!tip_codigo & "", vg_db, adOpenStatic
         If Not RS2.EOF Then
            '------- la propiedad Texto de los nodos postizos es "***"
