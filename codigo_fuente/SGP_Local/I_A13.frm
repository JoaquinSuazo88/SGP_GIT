...
Begin VB.Form I_A13 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CheckBox Check1 
         Caption         =   "Incluye Venta Resumida x Servicio"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
...
Select Case Button.Index
    ...
    Case 1
        ...
        RS.Close
        Set RS = Nothing
        If fpDateTime1(0).Value > fpDateTime1(1).Value Then MsgBox "Fecha inicial no puede ser mayor final", vbExclamation + vbOKOnly, MsgTitulo: Exit Sub
    ...
    '    If Mid(fpDateTime1(0).Text, 7, 4) <> Mid(fpDateTime1(1).Text, 7, 4) Then MsgBox "Año origen mayor destino", vbExclamation + vbOKOnly, MsgTitulo: Exit Sub
        If vg_pais = "CL" Then
           ...
           I_RA13 fpText.text, Val(Format(fpDateTime1(0).text, "yyyymmdd")), Val(Format(fpDateTime1(1).text, "yyyymmdd")), IIf(Check1(0).Value = 0, False, True), IIf(Check1(1).Value = 0, False, True), IIf(Check1(2).Value = 0, False, True)
        
        ElseIf vg_pais = "CO" Then
           
           I_RA13Colombia fpText.text, Val(Format(fpDateTime1(0).text, "yyyymmdd")), Val(Format(fpDateTime1(1).text, "yyyymmdd")), IIf(Check1(0).Value = 0, False, True), IIf(Check1(1).Value = 0, False, True), IIf(Check1(2).Value = 0, False, True)
