...
Begin VB.Form M_CpRPla 
   ...
   Begin FPSpread.vaSpread vaSpreadMes2 
      ...
      ScrollBars      =   0
      SelectBlockOptions=   0
      SpreadDesigner  =   "M_CpRPla.frx":055C
      UserResize      =   1
   End
   Begin FPSpread.vaSpread vaSpreadMes3 
      ...
      ScrollBars      =   0
      SelectBlockOptions=   0
      SpreadDesigner  =   "M_CpRPla.frx":0AB8
      UserResize      =   1
   End
...
Dim i As Long
    ...
    For i = 0 To UBound(vecdia)
        If NroMes = 1 Then
            If Trim(vaSpreadMes1(0).TypeButtonText) = vecdia(i) Then
...
Dim i As Long
    ...
    For i = 0 To UBound(vecdia)
        If NroMes = 2 Then
            If Trim(vaSpreadMes2(1).TypeButtonText) = vecdia(i) Then
...
Dim i As Long
    ...
    For i = 0 To UBound(vecdia)
        If NroMes = 3 Then
            If Trim(vaSpreadMes3(0).TypeButtonText) = vecdia(i) Then
